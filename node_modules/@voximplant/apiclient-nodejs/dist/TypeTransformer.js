...
class TypeTransformer {
    static from(type) {
        ...
        if (isArray)
            return function (data) { return data.map(transformer); };
        return transformer;
    }
    static to(type) {
        const isArray = TypeTransformer.hasArrayBrackets(type);
    ...
    static hasArrayBrackets(type) {
        return (type.indexOf('[') === 0 && type.indexOf(']') === (type.length - 1));
    }
    static fromStatic(type) {
...
TypeTransformer.fromActors = {
    ...
    'AccountInfoType': function (data) {
        ...
        if (typeof data['account_name'] !== 'undefined')
            xData['accountName'] = TypeTransformer.to('string')(data['account_name']);
        ...
        if (typeof data['account_first_name'] !== 'undefined')
            xData['accountFirstName'] = TypeTransformer.to('string')(data['account_first_name']);
        ...
        if (typeof data['location'] !== 'undefined')
            xData['location'] = TypeTransformer.to('string')(data['location']);
        if (typeof data['min_balance_to_notify'] !== 'undefined')
            xData['minBalanceToNotify'] = TypeTransformer.to('number')(data['min_balance_to_notify']);
        if (typeof data['account_notifications'] !== 'undefined')
            xData['accountNotifications'] = TypeTransformer.to('boolean')(data['account_notifications']);
        if (typeof data['tariff_changing_notifications'] !== 'undefined')
            xData['tariffChangingNotifications'] = TypeTransformer.to('boolean')(data['tariff_changing_notifications']);
        if (typeof data['news_notifications'] !== 'undefined')
            xData['newsNotifications'] = TypeTransformer.to('boolean')(data['news_notifications']);
        if (typeof data['billing_address_name'] !== 'undefined')
            xData['billingAddressName'] = TypeTransformer.to('string')(data['billing_address_name']);
        if (typeof data['billing_address_country_code'] !== 'undefined')
            xData['billingAddressCountryCode'] = TypeTransformer.to('string')(data['billing_address_country_code']);
        if (typeof data['billing_address_address'] !== 'undefined')
            xData['billingAddressAddress'] = TypeTransformer.to('string')(data['billing_address_address']);
        if (typeof data['billing_address_zip'] !== 'undefined')
            xData['billingAddressZip'] = TypeTransformer.to('string')(data['billing_address_zip']);
        if (typeof data['billing_address_phone'] !== 'undefined')
            xData['billingAddressPhone'] = TypeTransformer.to('string')(data['billing_address_phone']);
        if (typeof data['billing_address_state'] !== 'undefined')
            xData['billingAddressState'] = TypeTransformer.to('string')(data['billing_address_state']);
        if (typeof data['active'] !== 'undefined')
            xData['active'] = TypeTransformer.to('boolean')(data['active']);
        if (typeof data['frozen'] !== 'undefined')
            xData['frozen'] = TypeTransformer.to('boolean')(data['frozen']);
        if (typeof data['balance'] !== 'undefined')
            xData['balance'] = TypeTransformer.to('number')(data['balance']);
        if (typeof data['credit_limit'] !== 'undefined')
            xData['creditLimit'] = TypeTransformer.to('number')(data['credit_limit']);
        if (typeof data['currency'] !== 'undefined')
            xData['currency'] = TypeTransformer.to('string')(data['currency']);
        if (typeof data['support_robokassa'] !== 'undefined')
            xData['supportRobokassa'] = TypeTransformer.to('boolean')(data['support_robokassa']);
        if (typeof data['support_bank_card'] !== 'undefined')
            xData['supportBankCard'] = TypeTransformer.to('boolean')(data['support_bank_card']);
        if (typeof data['support_invoice'] !== 'undefined')
            xData['supportInvoice'] = TypeTransformer.to('boolean')(data['support_invoice']);
        if (typeof data['account_custom_data'] !== 'undefined')
            xData['accountCustomData'] = TypeTransformer.to('string')(data['account_custom_data']);
        if (typeof data['access_entries'] !== 'undefined')
            xData['accessEntries'] = TypeTransformer.to('string[]')(data['access_entries']);
        if (typeof data['with_access_entries'] !== 'undefined')
            xData['withAccessEntries'] = TypeTransformer.to('boolean')(data['with_access_entries']);
        if (typeof data['callback_url'] !== 'undefined')
            xData['callbackUrl'] = TypeTransformer.to('string')(data['callback_url']);
        if (typeof data['callback_salt'] !== 'undefined')
            xData['callbackSalt'] = TypeTransformer.to('string')(data['callback_salt']);
    ...
    'AccountPlanType': function (data) {
        ...
        if (typeof data['plan_subscription_template_id'] !== 'undefined')
            xData['planSubscriptionTemplateId'] = TypeTransformer.to('number')(data['plan_subscription_template_id']);
        ...
        if (typeof data['plan_name'] !== 'undefined')
            xData['planName'] = TypeTransformer.to('string')(data['plan_name']);
    ...
    'AccountPlanPackageType': function (data) {
        ...
        if (typeof data['package_name'] !== 'undefined')
            xData['packageName'] = TypeTransformer.to('string')(data['package_name']);
        if (typeof data['may_overrun'] !== 'undefined')
            xData['mayOverrun'] = TypeTransformer.to('boolean')(data['may_overrun']);
        if (typeof data['overrun_price'] !== 'undefined')
            xData['overrunPrice'] = TypeTransformer.to('number')(data['overrun_price']);
        if (typeof data['overrun_resources'] !== 'undefined')
            xData['overrunResources'] = TypeTransformer.to('number')(data['overrun_resources']);
        if (typeof data['resource_left'] !== 'undefined')
            xData['resourceLeft'] = TypeTransformer.to('number')(data['resource_left']);
        if (typeof data['package_size'] !== 'undefined')
            xData['packageSize'] = TypeTransformer.to('number')(data['package_size']);
        if (typeof data['orig_package_size'] !== 'undefined')
            xData['origPackageSize'] = TypeTransformer.to('number')(data['orig_package_size']);
        return xData;
    },
    ...
    'UserInfoType': function (data) {
        ...
        if (typeof data['user_name'] !== 'undefined')
            xData['userName'] = TypeTransformer.to('string')(data['user_name']);
        if (typeof data['user_display_name'] !== 'undefined')
            xData['userDisplayName'] = TypeTransformer.to('string')(data['user_display_name']);
        if (typeof data['user_active'] !== 'undefined')
            xData['userActive'] = TypeTransformer.to('boolean')(data['user_active']);
        if (typeof data['parent_accounting'] !== 'undefined')
            xData['parentAccounting'] = TypeTransformer.to('boolean')(data['parent_accounting']);
        if (typeof data['live_balance'] !== 'undefined')
            xData['liveBalance'] = TypeTransformer.to('number')(data['live_balance']);
        if (typeof data['balance'] !== 'undefined')
            xData['balance'] = TypeTransformer.to('number')(data['balance']);
        if (typeof data['fixed_balance'] !== 'undefined')
            xData['fixedBalance'] = TypeTransformer.to('number')(data['fixed_balance']);
    ...
    'ScenarioInfoType': function (data) {
        ...
        if (typeof data['scenario_name'] !== 'undefined')
            xData['scenarioName'] = TypeTransformer.to('string')(data['scenario_name']);
    ...
    'RuleInfoType': function (data) {
        ...
        if (typeof data['rule_pattern'] !== 'undefined')
            xData['rulePattern'] = TypeTransformer.to('string')(data['rule_pattern']);
        if (typeof data['rule_pattern_exclude'] !== 'undefined')
            xData['rulePatternExclude'] = TypeTransformer.to('string')(data['rule_pattern_exclude']);
    ...
    'SipWhiteListInfoType': function (data) {
        ...
        if (typeof data['sip_whitelist_network'] !== 'undefined')
            xData['sipWhitelistNetwork'] = TypeTransformer.to('string')(data['sip_whitelist_network']);
    ...
    'CallSessionInfoType': function (data) {
        ...
        if (typeof data['application_name'] !== 'undefined')
            xData['applicationName'] = TypeTransformer.to('string')(data['application_name']);
        if (typeof data['call_session_history_id'] !== 'undefined')
            xData['callSessionHistoryId'] = TypeTransformer.to('number')(data['call_session_history_id']);
        if (typeof data['account_id'] !== 'undefined')
            xData['accountId'] = TypeTransformer.to('number')(data['account_id']);
        if (typeof data['application_id'] !== 'undefined')
            xData['applicationId'] = TypeTransformer.to('number')(data['application_id']);
        ...
        if (typeof data['initiator_address'] !== 'undefined')
            xData['initiatorAddress'] = TypeTransformer.to('string')(data['initiator_address']);
        if (typeof data['media_server_address'] !== 'undefined')
            xData['mediaServerAddress'] = TypeTransformer.to('string')(data['media_server_address']);
        if (typeof data['log_file_url'] !== 'undefined')
            xData['logFileUrl'] = TypeTransformer.to('string')(data['log_file_url']);
        ...
        if (typeof data['other_resource_usage'] !== 'undefined')
            xData['otherResourceUsage'] = TypeTransformer.to('ResourceUsage[]')(data['other_resource_usage']);
    ...
    'CallInfoType': function (data) {
        ...
        if (typeof data['local_number'] !== 'undefined')
            xData['localNumber'] = TypeTransformer.to('string')(data['local_number']);
        if (typeof data['remote_number'] !== 'undefined')
            xData['remoteNumber'] = TypeTransformer.to('string')(data['remote_number']);
        if (typeof data['remote_number_type'] !== 'undefined')
            xData['remoteNumberType'] = TypeTransformer.to('string')(data['remote_number_type']);
        if (typeof data['incoming'] !== 'undefined')
            xData['incoming'] = TypeTransformer.to('boolean')(data['incoming']);
        if (typeof data['successful'] !== 'undefined')
            xData['successful'] = TypeTransformer.to('boolean')(data['successful']);
    ...
    'TransactionInfoType': function (data) {
        ...
        if (typeof data['transaction_type'] !== 'undefined')
            xData['transactionType'] = TypeTransformer.to('string')(data['transaction_type']);
        if (typeof data['transaction_description'] !== 'undefined')
            xData['transactionDescription'] = TypeTransformer.to('string')(data['transaction_description']);
        return xData;
    },
    'ResourceUsageType': function (data) {
        ...
        if (typeof data['resource_quantity'] !== 'undefined')
            xData['resourceQuantity'] = TypeTransformer.to('number')(data['resource_quantity']);
        if (typeof data['unit'] !== 'undefined')
            xData['unit'] = TypeTransformer.to('string')(data['unit']);
        if (typeof data['ref_call_id'] !== 'undefined')
            xData['refCallId'] = TypeTransformer.to('number')(data['ref_call_id']);
        return xData;
    },
    'RecordType': function (data) {
        ...
        if (typeof data['record_name'] !== 'undefined')
            xData['recordName'] = TypeTransformer.to('string')(data['record_name']);
        if (typeof data['cost'] !== 'undefined')
            xData['cost'] = TypeTransformer.to('number')(data['cost']);
        if (typeof data['start_time'] !== 'undefined')
            xData['startTime'] = TypeTransformer.to('Date')(data['start_time']);
        ...
        if (typeof data['transcription_url'] !== 'undefined')
            xData['transcriptionUrl'] = TypeTransformer.to('string')(data['transcription_url']);
        if (typeof data['transcription_status'] !== 'undefined')
            xData['transcriptionStatus'] = TypeTransformer.to('string')(data['transcription_status']);
        return xData;
    },
    'AuditLogInfoType': function (data) {
        ...
        if (typeof data['ip'] !== 'undefined')
            xData['ip'] = TypeTransformer.to('string')(data['ip']);
    ...
    'CalculatedCallHistoryDataType': function (data) {
        ...
        if (typeof data['total_session_count'] !== 'undefined')
            xData['totalSessionCount'] = TypeTransformer.to('number')(data['total_session_count']);
        if (typeof data['timezone'] !== 'undefined')
            xData['timezone'] = TypeTransformer.to('string')(data['timezone']);
        return xData;
    },
    'CalculatedTransactionHistoryDataType': function (data) {
        ...
        if (typeof data['total_transaction_count'] !== 'undefined')
            xData['totalTransactionCount'] = TypeTransformer.to('number')(data['total_transaction_count']);
        if (typeof data['start_balance'] !== 'undefined')
            xData['startBalance'] = TypeTransformer.to('string')(data['start_balance']);
        if (typeof data['end_balance'] !== 'undefined')
            xData['endBalance'] = TypeTransformer.to('string')(data['end_balance']);
        if (typeof data['account_id'] !== 'undefined')
            xData['accountId'] = TypeTransformer.to('number')(data['account_id']);
        if (typeof data['user_id'] !== 'undefined')
            xData['userId'] = TypeTransformer.to('number')(data['user_id']);
        if (typeof data['user_name'] !== 'undefined')
            xData['userName'] = TypeTransformer.to('number')(data['user_name']);
        if (typeof data['timezone'] !== 'undefined')
            xData['timezone'] = TypeTransformer.to('string')(data['timezone']);
        return xData;
    },
    'ACDSessionInfoType': function (data) {
        ...
        if (typeof data['acd_request_id'] !== 'undefined')
            xData['acdRequestId'] = TypeTransformer.to('string')(data['acd_request_id']);
        if (typeof data['account_id'] !== 'undefined')
            xData['accountId'] = TypeTransformer.to('number')(data['account_id']);
        ...
        if (typeof data['user_id'] !== 'undefined')
            xData['userId'] = TypeTransformer.to('number')(data['user_id']);
        if (typeof data['waiting_duration'] !== 'undefined')
            xData['waitingDuration'] = TypeTransformer.to('number')(data['waiting_duration']);
        if (typeof data['in_service_duration'] !== 'undefined')
            xData['inServiceDuration'] = TypeTransformer.to('number')(data['in_service_duration']);
        if (typeof data['after_service_duration'] !== 'undefined')
            xData['afterServiceDuration'] = TypeTransformer.to('number')(data['after_service_duration']);
    ...
    'QueueInfoType': function (data) {
        ...
        if (typeof data['acd_queue_id'] !== 'undefined')
            xData['acdQueueId'] = TypeTransformer.to('number')(data['acd_queue_id']);
        if (typeof data['acd_queue_name'] !== 'undefined')
            xData['acdQueueName'] = TypeTransformer.to('string')(data['acd_queue_name']);
        if (typeof data['application_id'] !== 'undefined')
            xData['applicationId'] = TypeTransformer.to('number')(data['application_id']);
        if (typeof data['acd_queue_priority'] !== 'undefined')
            xData['acdQueuePriority'] = TypeTransformer.to('number')(data['acd_queue_priority']);
        if (typeof data['service_probability'] !== 'undefined')
            xData['serviceProbability'] = TypeTransformer.to('number')(data['service_probability']);
        if (typeof data['auto_binding'] !== 'undefined')
            xData['autoBinding'] = TypeTransformer.to('boolean')(data['auto_binding']);
        if (typeof data['max_waiting_time'] !== 'undefined')
            xData['maxWaitingTime'] = TypeTransformer.to('number')(data['max_waiting_time']);
        if (typeof data['max_queue_size'] !== 'undefined')
            xData['maxQueueSize'] = TypeTransformer.to('number')(data['max_queue_size']);
        ...
        if (typeof data['operatorcount'] !== 'undefined')
            xData['operatorcount'] = TypeTransformer.to('number')(data['operatorcount']);
        return xData;
    },
    'QueueSkills': function (data) {
        ...
        if (typeof data['skill_name'] !== 'undefined')
    ...
    'ACDOperatorStatusAggregationGroupType': function (data) {
        ...
        if (typeof data['hour'] !== 'undefined')
            xData['hour'] = TypeTransformer.to('number')(data['hour']);
        if (typeof data['statistics'] !== 'undefined')
            xData['statistics'] = TypeTransformer.to('ACDOperatorStatusStatistics[]')(data['statistics']);
        return xData;
    },
    'ACDOperatorStatisticsType': function (data) {
        ...
        if (typeof data['AC'] !== 'undefined')
            xData['AC'] = TypeTransformer.to('number')(data['AC']);
        if (typeof data['UAC'] !== 'undefined')
            xData['UAC'] = TypeTransformer.to('number')(data['UAC']);
        if (typeof data['TDT'] !== 'undefined')
            xData['TDT'] = TypeTransformer.to('number')(data['TDT']);
        if (typeof data['THT'] !== 'undefined')
            xData['THT'] = TypeTransformer.to('number')(data['THT']);
        if (typeof data['TTT'] !== 'undefined')
            xData['TTT'] = TypeTransformer.to('number')(data['TTT']);
        if (typeof data['TACW'] !== 'undefined')
            xData['TACW'] = TypeTransformer.to('number')(data['TACW']);
        return xData;
    },
    'ACDOperatorStatusStatisticsType': function (data) {
        ...
        if (typeof data['hour'] !== 'undefined')
            xData['hour'] = TypeTransformer.to('number')(data['hour']);
        if (typeof data['acd_status'] !== 'undefined')
            xData['acdStatus'] = TypeTransformer.to('ACDOperatorStatusStatisticsDetail[]')(data['acd_status']);
        return xData;
    },
    ...
    'ACDQueueStatisticsType': function (data) {
        ...
        if (typeof data['TC'] !== 'undefined')
            xData['TC'] = TypeTransformer.to('number')(data['TC']);
        if (typeof data['AC'] !== 'undefined')
        ...
        if (typeof data['TST'] !== 'undefined')
            xData['TST'] = TypeTransformer.to('number')(data['TST']);
        if (typeof data['TAT'] !== 'undefined')
            xData['TAT'] = TypeTransformer.to('number')(data['TAT']);
        if (typeof data['THT'] !== 'undefined')
            xData['THT'] = TypeTransformer.to('number')(data['THT']);
        if (typeof data['TTT'] !== 'undefined')
            xData['TTT'] = TypeTransformer.to('number')(data['TTT']);
    ...
    'ACDQueueStatisticsServiceLevelType': function (data) {
        ...
        if (typeof data['acceptable_waiting_time'] !== 'undefined')
            xData['acceptableWaitingTime'] = TypeTransformer.to('number')(data['acceptable_waiting_time']);
        if (typeof data['call_count'] !== 'undefined')
            xData['callCount'] = TypeTransformer.to('number')(data['call_count']);
        if (typeof data['service_level'] !== 'undefined')
            xData['serviceLevel'] = TypeTransformer.to('number')(data['service_level']);
        return xData;
    },
    'ACDStatisticsItemType': function (data) {
        ...
        if (typeof data['avg'] !== 'undefined')
            xData['avg'] = TypeTransformer.to('number')(data['avg']);
        if (typeof data['max'] !== 'undefined')
            xData['max'] = TypeTransformer.to('number')(data['max']);
        if (typeof data['count'] !== 'undefined')
            xData['count'] = TypeTransformer.to('number')(data['count']);
        if (typeof data['sum'] !== 'undefined')
            xData['sum'] = TypeTransformer.to('number')(data['sum']);
        return xData;
    },
    'ACDStatisticsCalls': function (data) {
        ...
        if (typeof data['percent'] !== 'undefined')
            xData['percent'] = TypeTransformer.to('number')(data['percent']);
        return xData;
    },
    'ACDQueueStateType': function (data) {
        ...
        if (typeof data['ready_operators'] !== 'undefined')
            xData['readyOperators'] = TypeTransformer.to('ACDReadyOperatorState[]')(data['ready_operators']);
        ...
        if (typeof data['locked_operators'] !== 'undefined')
            xData['lockedOperators'] = TypeTransformer.to('ACDLockedOperatorState[]')(data['locked_operators']);
        if (typeof data['locked_operators_count'] !== 'undefined')
            xData['lockedOperatorsCount'] = TypeTransformer.to('number')(data['locked_operators_count']);
        if (typeof data['after_service_operators'] !== 'undefined')
            xData['afterServiceOperators'] = TypeTransformer.to('ACDAfterServiceOperatorState[]')(data['after_service_operators']);
        if (typeof data['after_service_operator_count'] !== 'undefined')
            xData['afterServiceOperatorCount'] = TypeTransformer.to('number')(data['after_service_operator_count']);
        if (typeof data['servicing_calls'] !== 'undefined')
            xData['servicingCalls'] = TypeTransformer.to('ACDServicingCallState[]')(data['servicing_calls']);
    ...
    'ACDReadyOperatorStateType': function (data) {
        ...
        if (typeof data['user_display_name'] !== 'undefined')
            xData['userDisplayName'] = TypeTransformer.to('string')(data['user_display_name']);
        if (typeof data['idle_duration'] !== 'undefined')
            xData['idleDuration'] = TypeTransformer.to('number')(data['idle_duration']);
        return xData;
    },
    ...
    'ACDLock': function (data) {
        ...
        if (typeof data['id'] !== 'undefined')
            xData['id'] = TypeTransformer.to('string')(data['id']);
        if (typeof data['created'] !== 'undefined')
            xData['created'] = TypeTransformer.to('Date')(data['created']);
        return xData;
    },
    ...
    'ACDWaitingCallStateType': function (data) {
        ...
        if (typeof data['minutes_to_submit'] !== 'undefined')
            xData['minutesToSubmit'] = TypeTransformer.to('number')(data['minutes_to_submit']);
        if (typeof data['acd_session_history_id'] !== 'undefined')
            xData['acdSessionHistoryId'] = TypeTransformer.to('number')(data['acd_session_history_id']);
        return xData;
    },
    'NewPhoneInfoType': function (data) {
        ...
        if (typeof data['phone_price'] !== 'undefined')
            xData['phonePrice'] = TypeTransformer.to('number')(data['phone_price']);
        if (typeof data['phone_installation_price'] !== 'undefined')
            xData['phoneInstallationPrice'] = TypeTransformer.to('number')(data['phone_installation_price']);
        ...
        if (typeof data['phone_installation_tax_reserve'] !== 'undefined')
            xData['phoneInstallationTaxReserve'] = TypeTransformer.to('number')(data['phone_installation_tax_reserve']);
        if (typeof data['phone_tax_reserve'] !== 'undefined')
    ...
    'AttachedPhoneInfoType': function (data) {
        ...
        if (typeof data['canceled'] !== 'undefined')
            xData['canceled'] = TypeTransformer.to('boolean')(data['canceled']);
        ...
        if (typeof data['required_verification'] !== 'undefined')
            xData['requiredVerification'] = TypeTransformer.to('boolean')(data['required_verification']);
        ...
        if (typeof data['is_sms_enabled'] !== 'undefined')
            xData['isSmsEnabled'] = TypeTransformer.to('boolean')(data['is_sms_enabled']);
        if (typeof data['incoming_sms_callback_url'] !== 'undefined')
            xData['incomingSmsCallbackUrl'] = TypeTransformer.to('string')(data['incoming_sms_callback_url']);
        if (typeof data['emergency_calls_to_be_enabled'] !== 'undefined')
            xData['emergencyCallsToBeEnabled'] = TypeTransformer.to('boolean')(data['emergency_calls_to_be_enabled']);
        if (typeof data['emergency_calls_enabled'] !== 'undefined')
            xData['emergencyCallsEnabled'] = TypeTransformer.to('boolean')(data['emergency_calls_enabled']);
        if (typeof data['subscription_id'] !== 'undefined')
            xData['subscriptionId'] = TypeTransformer.to('number')(data['subscription_id']);
        if (typeof data['extended_application_name'] !== 'undefined')
            xData['extendedApplicationName'] = TypeTransformer.to('string')(data['extended_application_name']);
        if (typeof data['phone_region_name'] !== 'undefined')
            xData['phoneRegionName'] = TypeTransformer.to('string')(data['phone_region_name']);
        if (typeof data['modified'] !== 'undefined')
            xData['modified'] = TypeTransformer.to('Date')(data['modified']);
    ...
    'PhoneNumberCountryInfoType': function (data) {
        ...
        if (typeof data['can_list_phone_numbers'] !== 'undefined')
            xData['canListPhoneNumbers'] = TypeTransformer.to('boolean')(data['can_list_phone_numbers']);
        if (typeof data['phone_categories'] !== 'undefined')
            xData['phoneCategories'] = TypeTransformer.to('PhoneNumberCountryCategoryInfo[]')(data['phone_categories']);
        if (typeof data['emergency_calls_to_be_enabled'] !== 'undefined')
            xData['emergencyCallsToBeEnabled'] = TypeTransformer.to('boolean')(data['emergency_calls_to_be_enabled']);
        return xData;
    },
    'PhoneNumberCountryCategoryInfoType': function (data) {
        ...
        if (typeof data['phone_category_name'] !== 'undefined')
            xData['phoneCategoryName'] = TypeTransformer.to('string')(data['phone_category_name']);
        if (typeof data['country_has_states'] !== 'undefined')
            xData['countryHasStates'] = TypeTransformer.to('boolean')(data['country_has_states']);
        if (typeof data['localized_country_name'] !== 'undefined')
            xData['localizedCountryName'] = TypeTransformer.to('string')(data['localized_country_name']);
        if (typeof data['localized_phone_category_name'] !== 'undefined')
            xData['localizedPhoneCategoryName'] = TypeTransformer.to('string')(data['localized_phone_category_name']);
        if (typeof data['localized_phone_region_name'] !== 'undefined')
            xData['localizedPhoneRegionName'] = TypeTransformer.to('string')(data['localized_phone_region_name']);
        return xData;
    },
    'PhoneNumberCountryStateInfoType': function (data) {
        ...
        if (typeof data['country_state_name'] !== 'undefined')
            xData['countryStateName'] = TypeTransformer.to('string')(data['country_state_name']);
        return xData;
    },
    'PhoneNumberCountryRegionInfoType': function (data) {
        ...
        if (typeof data['phone_region_name'] !== 'undefined')
            xData['phoneRegionName'] = TypeTransformer.to('string')(data['phone_region_name']);
        if (typeof data['phone_region_code'] !== 'undefined')
            xData['phoneRegionCode'] = TypeTransformer.to('string')(data['phone_region_code']);
        if (typeof data['phone_count'] !== 'undefined')
            xData['phoneCount'] = TypeTransformer.to('number')(data['phone_count']);
        if (typeof data['verification_status'] !== 'undefined')
            xData['verificationStatus'] = TypeTransformer.to('string')(data['verification_status']);
        if (typeof data['required_verification'] !== 'undefined')
            xData['requiredVerification'] = TypeTransformer.to('boolean')(data['required_verification']);
        ...
        if (typeof data['is_need_regulation_address'] !== 'undefined')
            xData['isNeedRegulationAddress'] = TypeTransformer.to('boolean')(data['is_need_regulation_address']);
        if (typeof data['regulation_address_type'] !== 'undefined')
            xData['regulationAddressType'] = TypeTransformer.to('string')(data['regulation_address_type']);
        if (typeof data['is_sms_supported'] !== 'undefined')
            xData['isSmsSupported'] = TypeTransformer.to('boolean')(data['is_sms_supported']);
        if (typeof data['multiple_numbers_price'] !== 'undefined')
            xData['multipleNumbersPrice'] = TypeTransformer.to('MultipleNumbersPrice[]')(data['multiple_numbers_price']);
        if (typeof data['localized_country_name'] !== 'undefined')
            xData['localizedCountryName'] = TypeTransformer.to('string')(data['localized_country_name']);
        if (typeof data['localized_phone_category_name'] !== 'undefined')
            xData['localizedPhoneCategoryName'] = TypeTransformer.to('string')(data['localized_phone_category_name']);
    ...
    'MultipleNumbersPrice': function (data) {
        ...
        if (typeof data['price'] !== 'undefined')
            xData['price'] = TypeTransformer.to('number')(data['price']);
        ...
        if (typeof data['installation_tax_reserve'] !== 'undefined')
            xData['installationTaxReserve'] = TypeTransformer.to('number')(data['installation_tax_reserve']);
        if (typeof data['tax_reserve'] !== 'undefined')
            xData['taxReserve'] = TypeTransformer.to('number')(data['tax_reserve']);
        return xData;
    },
    'CallerIDInfoType': function (data) {
        ...
        if (typeof data['callerid_number'] !== 'undefined')
            xData['calleridNumber'] = TypeTransformer.to('string')(data['callerid_number']);
        if (typeof data['active'] !== 'undefined')
            xData['active'] = TypeTransformer.to('boolean')(data['active']);
        if (typeof data['code_entering_attempts_left'] !== 'undefined')
            xData['codeEnteringAttemptsLeft'] = TypeTransformer.to('number')(data['code_entering_attempts_left']);
        if (typeof data['verification_call_attempts_left'] !== 'undefined')
            xData['verificationCallAttemptsLeft'] = TypeTransformer.to('number')(data['verification_call_attempts_left']);
    ...
    'OutboundTestPhonenumberInfoType': function (data) {
        ...
        if (typeof data['is_verified'] !== 'undefined')
            xData['isVerified'] = TypeTransformer.to('boolean')(data['is_verified']);
        if (typeof data['country_code'] !== 'undefined')
            xData['countryCode'] = TypeTransformer.to('string')(data['country_code']);
        return xData;
    },
    'ContactInfoType': function (data) {
        ...
        if (typeof data['contact_type'] !== 'undefined')
            xData['contactType'] = TypeTransformer.to('string')(data['contact_type']);
        if (typeof data['contact_data'] !== 'undefined')
            xData['contactData'] = TypeTransformer.to('string')(data['contact_data']);
        if (typeof data['is_persistent'] !== 'undefined')
            xData['isPersistent'] = TypeTransformer.to('boolean')(data['is_persistent']);
        if (typeof data['description'] !== 'undefined')
            xData['description'] = TypeTransformer.to('string')(data['description']);
        if (typeof data['next_verification_after_sec'] !== 'undefined')
            xData['nextVerificationAfterSec'] = TypeTransformer.to('number')(data['next_verification_after_sec']);
    ...
    'ACDQueueOperatorInfoType': function (data) {
        ...
        if (typeof data['acd_queue_name'] !== 'undefined')
            xData['acdQueueName'] = TypeTransformer.to('string')(data['acd_queue_name']);
        if (typeof data['auto_link'] !== 'undefined')
            xData['autoLink'] = TypeTransformer.to('boolean')(data['auto_link']);
        return xData;
    },
    ...
    'ExchangeRates': function (data) {
        ...
        if (typeof data['EUR'] !== 'undefined')
            xData['EUR'] = TypeTransformer.to('number')(data['EUR']);
        if (typeof data['USD'] !== 'undefined')
            xData['USD'] = TypeTransformer.to('number')(data['USD']);
        return xData;
    },
    ...
    'PriceGroup': function (data) {
        ...
        if (typeof data['price'] !== 'undefined')
            xData['price'] = TypeTransformer.to('number')(data['price']);
        if (typeof data['num_resources_per_price'] !== 'undefined')
            xData['numResourcesPerPrice'] = TypeTransformer.to('number')(data['num_resources_per_price']);
    ...
    'ResourceParams': function (data) {
        ...
        if (typeof data['forbidden'] !== 'undefined')
            xData['forbidden'] = TypeTransformer.to('string[]')(data['forbidden']);
        if (typeof data['requested'] !== 'undefined')
            xData['requested'] = TypeTransformer.to('string[]')(data['requested']);
        return xData;
    },
    'CallListType': function (data) {
        ...
        if (typeof data['list_name'] !== 'undefined')
            xData['listName'] = TypeTransformer.to('string')(data['list_name']);
        if (typeof data['priority'] !== 'undefined')
            xData['priority'] = TypeTransformer.to('number')(data['priority']);
        if (typeof data['rule_id'] !== 'undefined')
            xData['ruleId'] = TypeTransformer.to('number')(data['rule_id']);
        if (typeof data['max_simultaneous'] !== 'undefined')
            xData['maxSimultaneous'] = TypeTransformer.to('number')(data['max_simultaneous']);
    ...
    'CallListDetailType': function (data) {
        ...
        if (typeof data['last_attempt'] !== 'undefined')
            xData['lastAttempt'] = TypeTransformer.to('string')(data['last_attempt']);
        if (typeof data['attempts_left'] !== 'undefined')
            xData['attemptsLeft'] = TypeTransformer.to('number')(data['attempts_left']);
    ...
    'SIPRegistrationType': function (data) {
        ...
        if (typeof data['sip_username'] !== 'undefined')
            xData['sipUsername'] = TypeTransformer.to('string')(data['sip_username']);
        if (typeof data['proxy'] !== 'undefined')
            xData['proxy'] = TypeTransformer.to('string')(data['proxy']);
        if (typeof data['last_updated'] !== 'undefined')
            xData['lastUpdated'] = TypeTransformer.to('number')(data['last_updated']);
        if (typeof data['auth_user'] !== 'undefined')
            xData['authUser'] = TypeTransformer.to('string')(data['auth_user']);
        if (typeof data['outbound_proxy'] !== 'undefined')
            xData['outboundProxy'] = TypeTransformer.to('string')(data['outbound_proxy']);
        if (typeof data['successful'] !== 'undefined')
            xData['successful'] = TypeTransformer.to('boolean')(data['successful']);
        if (typeof data['status_code'] !== 'undefined')
            xData['statusCode'] = TypeTransformer.to('number')(data['status_code']);
        if (typeof data['error_message'] !== 'undefined')
            xData['errorMessage'] = TypeTransformer.to('string')(data['error_message']);
        if (typeof data['deactivated'] !== 'undefined')
            xData['deactivated'] = TypeTransformer.to('boolean')(data['deactivated']);
        if (typeof data['next_subscription_renewal'] !== 'undefined')
            xData['nextSubscriptionRenewal'] = TypeTransformer.to('Date')(data['next_subscription_renewal']);
    ...
    'AdminUserType': function (data) {
        ...
        if (typeof data['admin_user_display_name'] !== 'undefined')
            xData['adminUserDisplayName'] = TypeTransformer.to('string')(data['admin_user_display_name']);
    ...
    'ClonedAdminUserType': function (data) {
        ...
        if (typeof data['admin_user_name'] !== 'undefined')
            xData['adminUserName'] = TypeTransformer.to('string')(data['admin_user_name']);
        if (typeof data['admin_user_api_key'] !== 'undefined')
            xData['adminUserApiKey'] = TypeTransformer.to('string')(data['admin_user_api_key']);
        return xData;
    },
    'GetMoneyAmountToChargeResult': function (data) {
        ...
        if (typeof data['min_amount'] !== 'undefined')
            xData['minAmount'] = TypeTransformer.to('number')(data['min_amount']);
        if (typeof data['bank_card_amount_usd'] !== 'undefined')
            xData['bankCardAmountUsd'] = TypeTransformer.to('number')(data['bank_card_amount_usd']);
        if (typeof data['min_bank_card_amount_usd'] !== 'undefined')
            xData['minBankCardAmountUsd'] = TypeTransformer.to('number')(data['min_bank_card_amount_usd']);
        if (typeof data['robokassa_amount_rub'] !== 'undefined')
            xData['robokassaAmountRub'] = TypeTransformer.to('number')(data['robokassa_amount_rub']);
        if (typeof data['min_robokassa_amount_rub'] !== 'undefined')
            xData['minRobokassaAmountRub'] = TypeTransformer.to('number')(data['min_robokassa_amount_rub']);
        if (typeof data['subscriptions'] !== 'undefined')
            xData['subscriptions'] = TypeTransformer.to('SubscriptionsToCharge[]')(data['subscriptions']);
        return xData;
    },
    ...
    'ChargedPhoneType': function (data) {
        ...
        if (typeof data['deactivated'] !== 'undefined')
            xData['deactivated'] = TypeTransformer.to('boolean')(data['deactivated']);
        if (typeof data['is_charged'] !== 'undefined')
            xData['isCharged'] = TypeTransformer.to('boolean')(data['is_charged']);
        return xData;
    },
    'SubscriptionsToChargeType': function (data) {
        ...
        if (typeof data['subscription_type'] !== 'undefined')
            xData['subscriptionType'] = TypeTransformer.to('string')(data['subscription_type']);
        if (typeof data['subscription_description'] !== 'undefined')
            xData['subscriptionDescription'] = TypeTransformer.to('string')(data['subscription_description']);
        if (typeof data['subscription_auto_charge'] !== 'undefined')
            xData['subscriptionAutoCharge'] = TypeTransformer.to('boolean')(data['subscription_auto_charge']);
        if (typeof data['subscription_next_renewal'] !== 'undefined')
            xData['subscriptionNextRenewal'] = TypeTransformer.to('Date')(data['subscription_next_renewal']);
        return xData;
    },
    ...
    'AccountVerificationDocument': function (data) {
        ...
        if (typeof data['account_document_status'] !== 'undefined')
            xData['accountDocumentStatus'] = TypeTransformer.to('string')(data['account_document_status']);
        return xData;
    },
    ...
    'SubscriptionTemplateType': function (data) {
        ...
        if (typeof data['subscription_template_id'] !== 'undefined')
            xData['subscriptionTemplateId'] = TypeTransformer.to('number')(data['subscription_template_id']);
        ...
        if (typeof data['installation_price_in_currency'] !== 'undefined')
            xData['installationPriceInCurrency'] = TypeTransformer.to('number')(data['installation_price_in_currency']);
        if (typeof data['price'] !== 'undefined')
            xData['price'] = TypeTransformer.to('number')(data['price']);
        if (typeof data['price_in_currency'] !== 'undefined')
            xData['priceInCurrency'] = TypeTransformer.to('number')(data['price_in_currency']);
        if (typeof data['period'] !== 'undefined')
            xData['period'] = TypeTransformer.to('string')(data['period']);
        if (typeof data['subscription_template_type'] !== 'undefined')
            xData['subscriptionTemplateType'] = TypeTransformer.to('string')(data['subscription_template_type']);
        if (typeof data['subscription_template_name'] !== 'undefined')
            xData['subscriptionTemplateName'] = TypeTransformer.to('string')(data['subscription_template_name']);
        if (typeof data['required_verification'] !== 'undefined')
            xData['requiredVerification'] = TypeTransformer.to('boolean')(data['required_verification']);
        if (typeof data['verification_status'] !== 'undefined')
            xData['verificationStatus'] = TypeTransformer.to('string')(data['verification_status']);
    ...
    'AccountCallback': function (data) {
        ...
        if (typeof data['hash'] !== 'undefined')
            xData['hash'] = TypeTransformer.to('string')(data['hash']);
        if (typeof data['account_name'] !== 'undefined')
            xData['accountName'] = TypeTransformer.to('string')(data['account_name']);
        if (typeof data['account_email'] !== 'undefined')
            xData['accountEmail'] = TypeTransformer.to('string')(data['account_email']);
        ...
        if (typeof data['account_document_uploaded'] !== 'undefined')
            xData['accountDocumentUploaded'] = TypeTransformer.to('AccountDocumentUploadedCallback')(data['account_document_uploaded']);
        if (typeof data['regulation_address_uploaded'] !== 'undefined')
            xData['regulationAddressUploaded'] = TypeTransformer.to('RegulationAddressUploadedCallback')(data['regulation_address_uploaded']);
        if (typeof data['account_document_verified'] !== 'undefined')
            xData['accountDocumentVerified'] = TypeTransformer.to('AccountDocumentVerifiedCallback')(data['account_document_verified']);
        if (typeof data['account_is_frozen'] !== 'undefined')
            xData['accountIsFrozen'] = TypeTransformer.to('AccountIsFrozenCallback')(data['account_is_frozen']);
        if (typeof data['account_is_unfrozen'] !== 'undefined')
            xData['accountIsUnfrozen'] = TypeTransformer.to('AccountIsUnfrozenCallback')(data['account_is_unfrozen']);
        if (typeof data['activate_successful'] !== 'undefined')
            xData['activateSuccessful'] = TypeTransformer.to('ActivateSuccessfulCallback')(data['activate_successful']);
        if (typeof data['call_history_report'] !== 'undefined')
            xData['callHistoryReport'] = TypeTransformer.to('CallHistoryReportCallback')(data['call_history_report']);
        ...
        if (typeof data['card_expires_in_month'] !== 'undefined')
            xData['cardExpiresInMonth'] = TypeTransformer.to('CardExpiresInMonthCallback')(data['card_expires_in_month']);
        ...
        if (typeof data['card_payment_failed'] !== 'undefined')
            xData['cardPaymentFailed'] = TypeTransformer.to('CardPaymentFailedCallback')(data['card_payment_failed']);
        if (typeof data['robokassa_payment'] !== 'undefined')
            xData['robokassaPayment'] = TypeTransformer.to('RobokassaPaymentCallback')(data['robokassa_payment']);
        ...
        if (typeof data['regulation_address_verified'] !== 'undefined')
            xData['regulationAddressVerified'] = TypeTransformer.to('RegulationAddressVerifiedCallback')(data['regulation_address_verified']);
        if (typeof data['renewed_subscriptions'] !== 'undefined')
            xData['renewedSubscriptions'] = TypeTransformer.to('RenewedSubscriptionsCallback')(data['renewed_subscriptions']);
        if (typeof data['reset_account_password_request'] !== 'undefined')
            xData['resetAccountPasswordRequest'] = TypeTransformer.to('ResetAccountPasswordRequestCallback')(data['reset_account_password_request']);
        if (typeof data['sip_registration_fail'] !== 'undefined')
            xData['sipRegistrationFail'] = TypeTransformer.to('SIPRegistrationFailCallback')(data['sip_registration_fail']);
        if (typeof data['sip_registration_recovered'] !== 'undefined')
            xData['sipRegistrationRecovered'] = TypeTransformer.to('SIPRegistrationRecoveredCallback')(data['sip_registration_recovered']);
        if (typeof data['subscription_is_frozen'] !== 'undefined')
            xData['subscriptionIsFrozen'] = TypeTransformer.to('SubscriptionIsFrozenCallback')(data['subscription_is_frozen']);
        if (typeof data['subscription_is_detached'] !== 'undefined')
            xData['subscriptionIsDetached'] = TypeTransformer.to('SubscriptionIsDetachedCallback')(data['subscription_is_detached']);
        if (typeof data['transaction_history_report'] !== 'undefined')
            xData['transactionHistoryReport'] = TypeTransformer.to('TransactionHistoryReportCallback')(data['transaction_history_report']);
        if (typeof data['unverified_subscription_detached'] !== 'undefined')
            xData['unverifiedSubscriptionDetached'] = TypeTransformer.to('UnverifiedSubscriptionDetachedCallback')(data['unverified_subscription_detached']);
        if (typeof data['expiring_callerid'] !== 'undefined')
            xData['expiringCallerid'] = TypeTransformer.to('ExpiringCallerIDCallback')(data['expiring_callerid']);
        if (typeof data['transcription_complete'] !== 'undefined')
            xData['transcriptionComplete'] = TypeTransformer.to('TranscriptionCompleteCallback')(data['transcription_complete']);
        ...
        if (typeof data['expiring_agreement'] !== 'undefined')
            xData['expiringAgreement'] = TypeTransformer.to('ExpiringAgreementCallback')(data['expiring_agreement']);
        if (typeof data['expired_agreement'] !== 'undefined')
            xData['expiredAgreement'] = TypeTransformer.to('ExpiredAgreementCallback')(data['expired_agreement']);
        if (typeof data['restored_agreement_status'] !== 'undefined')
            xData['restoredAgreementStatus'] = TypeTransformer.to('RestoredAgreementStatusCallback')(data['restored_agreement_status']);
        if (typeof data['next_charge_alert'] !== 'undefined')
            xData['nextChargeAlert'] = TypeTransformer.to('NextChargeAlertCallback')(data['next_charge_alert']);
        if (typeof data['certificate_expired'] !== 'undefined')
            xData['certificateExpired'] = TypeTransformer.to('CertificateExpiredCallback')(data['certificate_expired']);
        if (typeof data['expired_certificates'] !== 'undefined')
            xData['expiredCertificates'] = TypeTransformer.to('ExpiredCertificateCallback')(data['expired_certificates']);
        if (typeof data['expiring_certificates'] !== 'undefined')
            xData['expiringCertificates'] = TypeTransformer.to('ExpiringCertificateCallback')(data['expiring_certificates']);
        if (typeof data['account_document_status_updated'] !== 'undefined')
            xData['accountDocumentStatusUpdated'] = TypeTransformer.to('AccountDocumentStatusUpdatedCallback')(data['account_document_status_updated']);
        if (typeof data['a2p_sms_activated'] !== 'undefined')
            xData['a2pSmsActivated'] = TypeTransformer.to('A2PActivatedCallback')(data['a2p_sms_activated']);
        if (typeof data['regulation_address_documents_requested'] !== 'undefined')
            xData['regulationAddressDocumentsRequested'] = TypeTransformer.to('RegulationAddressDocumentsRequestedCallback')(data['regulation_address_documents_requested']);
        if (typeof data['invoice_received'] !== 'undefined')
            xData['invoiceReceived'] = TypeTransformer.to('InvoiceReceivedCallback')(data['invoice_received']);
        return xData;
    },
    'A2PSmsDeliveryCallback': function (data) {
        const xData = {};
        if (typeof data['id'] !== 'undefined')
            xData['id'] = TypeTransformer.to('number')(data['id']);
        if (typeof data['source_number'] !== 'undefined')
            xData['sourceNumber'] = TypeTransformer.to('string')(data['source_number']);
        if (typeof data['status'] !== 'undefined')
            xData['status'] = TypeTransformer.to('string')(data['status']);
        if (typeof data['destination_numbers'] !== 'undefined')
            xData['destinationNumbers'] = TypeTransformer.to('string')(data['destination_numbers']);
        return xData;
    },
    ...
    'RegulationAddressUploadedCallback': function (data) {
        ...
        if (typeof data['regulation_address_name'] !== 'undefined')
            xData['regulationAddressName'] = TypeTransformer.to('string')(data['regulation_address_name']);
        return xData;
    },
    ...
    'MinBalanceCallback': function (data) {
        ...
        if (typeof data['is_repeated'] !== 'undefined')
            xData['isRepeated'] = TypeTransformer.to('boolean')(data['is_repeated']);
        return xData;
    },
    'RegulationAddressVerifiedCallback': function (data) {
        ...
        if (typeof data['regulation_address_id'] !== 'undefined')
            xData['regulationAddressId'] = TypeTransformer.to('number')(data['regulation_address_id']);
        if (typeof data['regulation_address_status'] !== 'undefined')
            xData['regulationAddressStatus'] = TypeTransformer.to('string')(data['regulation_address_status']);
        if (typeof data['uploaded'] !== 'undefined')
            xData['uploaded'] = TypeTransformer.to('Date')(data['uploaded']);
        if (typeof data['is_individual'] !== 'undefined')
            xData['isIndividual'] = TypeTransformer.to('boolean')(data['is_individual']);
    ...
    'RenewedSubscriptionsCallback': function (data) {
        const xData = {};
        if (typeof data['subscriptions'] !== 'undefined')
            xData['subscriptions'] = TypeTransformer.to('RenewedSubscriptionsCallbackItem[]')(data['subscriptions']);
        return xData;
    },
    ...
    'SIPRegistrationFailCallback': function (data) {
        ...
        if (typeof data['sip_registrations'] !== 'undefined')
            xData['sipRegistrations'] = TypeTransformer.to('SIPRegistrationIsFailedCallbackItem[]')(data['sip_registrations']);
        return xData;
    },
    'SIPRegistrationIsFailedCallbackItem': function (data) {
        ...
        if (typeof data['sip_registration_id'] !== 'undefined')
            xData['sipRegistrationId'] = TypeTransformer.to('number')(data['sip_registration_id']);
        if (typeof data['status_code'] !== 'undefined')
            xData['statusCode'] = TypeTransformer.to('string')(data['status_code']);
        if (typeof data['error_message'] !== 'undefined')
            xData['errorMessage'] = TypeTransformer.to('string')(data['error_message']);
        return xData;
    },
    'SIPRegistrationRecoveredCallback': function (data) {
        const xData = {};
        if (typeof data['sip_registrations'] !== 'undefined')
            xData['sipRegistrations'] = TypeTransformer.to('SIPRegistrationIsRecoveredCallbackItem[]')(data['sip_registrations']);
        return xData;
    },
    ...
    'SubscriptionIsDetachedCallback': function (data) {
        const xData = {};
        if (typeof data['subscriptions'] !== 'undefined')
            xData['subscriptions'] = TypeTransformer.to('SubscriptionIsDetachedCallbackItem[]')(data['subscriptions']);
        return xData;
    },
    ...
    'SubscriptionIsFrozenCallback': function (data) {
        const xData = {};
        if (typeof data['subscriptions'] !== 'undefined')
            xData['subscriptions'] = TypeTransformer.to('SubscriptionIsFrozenCallbackItem[]')(data['subscriptions']);
        return xData;
    },
    ...
    'UnverifiedSubscriptionDetachedCallback': function (data) {
        const xData = {};
        if (typeof data['subscriptions'] !== 'undefined')
            xData['subscriptions'] = TypeTransformer.to('UnverifiedSubscriptionDetachedCallbackItem[]')(data['subscriptions']);
        return xData;
    },
    ...
    'TranscriptionCompleteCallback': function (data) {
        const xData = {};
        if (typeof data['transcription_complete'] !== 'undefined')
            xData['transcriptionComplete'] = TypeTransformer.to('TranscriptionCompleteCallbackItem')(data['transcription_complete']);
        return xData;
    },
    'TranscriptionCompleteCallbackItem': function (data) {
        ...
        if (typeof data['call_session_history_id'] !== 'undefined')
            xData['callSessionHistoryId'] = TypeTransformer.to('number')(data['call_session_history_id']);
        if (typeof data['transcription_cost'] !== 'undefined')
            xData['transcriptionCost'] = TypeTransformer.to('number')(data['transcription_cost']);
        return xData;
    },
    ...
    'NextChargeAlertCallback': function (data) {
        ...
        if (typeof data['insufficient_funds_amount'] !== 'undefined')
            xData['insufficientFundsAmount'] = TypeTransformer.to('number')(data['insufficient_funds_amount']);
        return xData;
    },
    ...
    'SubscriptionCallbackDetails': function (data) {
        ...
        if (typeof data['phone_numbers'] !== 'undefined')
            xData['phoneNumbers'] = TypeTransformer.to('SubscriptionCallbackDetailsPhoneNumbers[]')(data['phone_numbers']);
        if (typeof data['sip_registrations'] !== 'undefined')
            xData['sipRegistrations'] = TypeTransformer.to('SubscriptionCallbackDetailsSipRegistrations[]')(data['sip_registrations']);
        return xData;
    },
    ...
    'AccountDocumentStatusUpdatedCallback': function (data) {
        ...
        if (typeof data['account_document_id'] !== 'undefined')
            xData['accountDocumentId'] = TypeTransformer.to('number')(data['account_document_id']);
        if (typeof data['previous_account_document_status'] !== 'undefined')
            xData['previousAccountDocumentStatus'] = TypeTransformer.to('string')(data['previous_account_document_status']);
        if (typeof data['account_document_status'] !== 'undefined')
            xData['accountDocumentStatus'] = TypeTransformer.to('string')(data['account_document_status']);
    ...
    'InvoiceReceivedCallback': function (data) {
        ...
        if (typeof data['tax_amount'] !== 'undefined')
            xData['taxAmount'] = TypeTransformer.to('string')(data['tax_amount']);
        if (typeof data['currency'] !== 'undefined')
            xData['currency'] = TypeTransformer.to('string')(data['currency']);
        return xData;
    },
    'ZipCode': function (data) {
        ...
        if (typeof data['zip_code'] !== 'undefined')
            xData['zipCode'] = TypeTransformer.to('string')(data['zip_code']);
        return xData;
    },
    'RegulationCountry': function (data) {
        ...
        if (typeof data['country_name'] !== 'undefined')
            xData['countryName'] = TypeTransformer.to('string')(data['country_name']);
        return xData;
    },
    'RegulationAddress': function (data) {
        ...
        if (typeof data['external_id'] !== 'undefined')
            xData['externalId'] = TypeTransformer.to('string')(data['external_id']);
        if (typeof data['country_code'] !== 'undefined')
            xData['countryCode'] = TypeTransformer.to('string')(data['country_code']);
        if (typeof data['phone_category_name'] !== 'undefined')
            xData['phoneCategoryName'] = TypeTransformer.to('string')(data['phone_category_name']);
        if (typeof data['salutation'] !== 'undefined')
            xData['salutation'] = TypeTransformer.to('string')(data['salutation']);
        if (typeof data['company'] !== 'undefined')
            xData['company'] = TypeTransformer.to('string')(data['company']);
        if (typeof data['first_name'] !== 'undefined')
            xData['firstName'] = TypeTransformer.to('string')(data['first_name']);
        if (typeof data['last_name'] !== 'undefined')
            xData['lastName'] = TypeTransformer.to('string')(data['last_name']);
        if (typeof data['owner_country_code'] !== 'undefined')
            xData['ownerCountryCode'] = TypeTransformer.to('string')(data['owner_country_code']);
        if (typeof data['city'] !== 'undefined')
            xData['city'] = TypeTransformer.to('string')(data['city']);
        if (typeof data['zip_code'] !== 'undefined')
            xData['zipCode'] = TypeTransformer.to('string')(data['zip_code']);
        if (typeof data['street'] !== 'undefined')
            xData['street'] = TypeTransformer.to('string')(data['street']);
        if (typeof data['builder_number'] !== 'undefined')
            xData['builderNumber'] = TypeTransformer.to('string')(data['builder_number']);
        if (typeof data['builder_latter'] !== 'undefined')
            xData['builderLatter'] = TypeTransformer.to('string')(data['builder_latter']);
        if (typeof data['status'] !== 'undefined')
            xData['status'] = TypeTransformer.to('string')(data['status']);
        if (typeof data['reject_message'] !== 'undefined')
            xData['rejectMessage'] = TypeTransformer.to('string')(data['reject_message']);
        return xData;
    },
    ...
    'BankCardType': function (data) {
        ...
        if (typeof data['auto_charge'] !== 'undefined')
            xData['autoCharge'] = TypeTransformer.to('boolean')(data['auto_charge']);
        if (typeof data['min_balance '] !== 'undefined')
            xData['minBalance '] = TypeTransformer.to('number')(data['min_balance ']);
        if (typeof data['card_overrun_value'] !== 'undefined')
            xData['cardOverrunValue'] = TypeTransformer.to('number')(data['card_overrun_value']);
        if (typeof data['expiration_year'] !== 'undefined')
            xData['expirationYear'] = TypeTransformer.to('number')(data['expiration_year']);
        if (typeof data['expiration_month'] !== 'undefined')
            xData['expirationMonth'] = TypeTransformer.to('number')(data['expiration_month']);
        ...
        if (typeof data['card_type'] !== 'undefined')
            xData['cardType'] = TypeTransformer.to('string')(data['card_type']);
        return xData;
    },
    ...
    'PstnBlackListInfoType': function (data) {
        ...
        if (typeof data['pstn_blacklist_phone '] !== 'undefined')
            xData['pstnBlacklistPhone '] = TypeTransformer.to('string')(data['pstn_blacklist_phone ']);
        return xData;
    },
    ...
    'PushCredentialInfo': function (data) {
        ...
        if (typeof data['push_credential_id'] !== 'undefined')
            xData['pushCredentialId'] = TypeTransformer.to('number')(data['push_credential_id']);
        if (typeof data['push_provider_id'] !== 'undefined')
    ...
    'PushCredentialContent': function (data) {
        ...
        if (typeof data['cert_file_name'] !== 'undefined')
            xData['certFileName'] = TypeTransformer.to('string')(data['cert_file_name']);
        if (typeof data['cert_content'] !== 'undefined')
            xData['certContent'] = TypeTransformer.to('string')(data['cert_content']);
        if (typeof data['is_dev_mode'] !== 'undefined')
            xData['isDevMode'] = TypeTransformer.to('boolean')(data['is_dev_mode']);
        if (typeof data['sender_id'] !== 'undefined')
            xData['senderId'] = TypeTransformer.to('string')(data['sender_id']);
        if (typeof data['huawei_client_id'] !== 'undefined')
            xData['huaweiClientId'] = TypeTransformer.to('string')(data['huawei_client_id']);
        if (typeof data['huawei_application_id'] !== 'undefined')
            xData['huaweiApplicationId'] = TypeTransformer.to('string')(data['huawei_application_id']);
        return xData;
    },
    ...
    'InboundSmsCallbackItem': function (data) {
        ...
        if (typeof data['sms_body'] !== 'undefined')
            xData['smsBody'] = TypeTransformer.to('string')(data['sms_body']);
        return xData;
    },
    'RecordStorageInfoType': function (data) {
        ...
        if (typeof data['record_storage_name'] !== 'undefined')
            xData['recordStorageName'] = TypeTransformer.to('string')(data['record_storage_name']);
        return xData;
    },
    ...
    'FailedSms': function (data) {
        ...
        if (typeof data['error_description'] !== 'undefined')
            xData['errorDescription'] = TypeTransformer.to('string')(data['error_description']);
        if (typeof data['error_code'] !== 'undefined')
            xData['errorCode'] = TypeTransformer.to('number')(data['error_code']);
        return xData;
    },
    'KeyInfo': function (data) {
        ...
        if (typeof data['private_key'] !== 'undefined')
            xData['privateKey'] = TypeTransformer.to('string')(data['private_key']);
        return xData;
    },
    ...
    'RoleView': function (data) {
        ...
        if (typeof data['role_id'] !== 'undefined')
            xData['roleId'] = TypeTransformer.to('number')(data['role_id']);
        if (typeof data['inherited'] !== 'undefined')
            xData['inherited'] = TypeTransformer.to('boolean')(data['inherited']);
        if (typeof data['child_ids'] !== 'undefined')
            xData['childIds'] = TypeTransformer.to('number[]')(data['child_ids']);
        if (typeof data['parent_role_id'] !== 'undefined')
            xData['parentRoleId'] = TypeTransformer.to('number[]')(data['parent_role_id']);
        if (typeof data['gui_only'] !== 'undefined')
            xData['guiOnly'] = TypeTransformer.to('boolean')(data['gui_only']);
        return xData;
    },
    ...
    'SmsHistoryType': function (data) {
        ...
        if (typeof data['message_id'] !== 'undefined')
            xData['messageId'] = TypeTransformer.to('number')(data['message_id']);
        if (typeof data['source_number'] !== 'undefined')
            xData['sourceNumber'] = TypeTransformer.to('number')(data['source_number']);
        if (typeof data['destination_number'] !== 'undefined')
            xData['destinationNumber'] = TypeTransformer.to('number')(data['destination_number']);
        if (typeof data['direction'] !== 'undefined')
            xData['direction'] = TypeTransformer.to('string')(data['direction']);
        if (typeof data['fragments'] !== 'undefined')
            xData['fragments'] = TypeTransformer.to('number')(data['fragments']);
        if (typeof data['cost'] !== 'undefined')
            xData['cost'] = TypeTransformer.to('number')(data['cost']);
        if (typeof data['status_id'] !== 'undefined')
            xData['statusId'] = TypeTransformer.to('string')(data['status_id']);
        if (typeof data['error_message'] !== 'undefined')
            xData['errorMessage'] = TypeTransformer.to('string')(data['error_message']);
        ...
        if (typeof data['text'] !== 'undefined')
            xData['text'] = TypeTransformer.to('string')(data['text']);
        return xData;
    },
    'A2PSmsHistoryType': function (data) {
        ...
        if (typeof data['delivery_status'] !== 'undefined')
            xData['deliveryStatus'] = TypeTransformer.to('string')(data['delivery_status']);
        if (typeof data['text'] !== 'undefined')
            xData['text'] = TypeTransformer.to('string')(data['text']);
        return xData;
    },
    ...
    'GetMaxBankCardPaymentResultType': function (data) {
        ...
        if (typeof data['new_max_payment'] !== 'undefined')
            xData['newMaxPayment'] = TypeTransformer.to('number')(data['new_max_payment']);
        if (typeof data['currency'] !== 'undefined')
            xData['currency'] = TypeTransformer.to('string')(data['currency']);
        return xData;
    },
    'GetAutochargeConfigResultType': function (data) {
        ...
        if (typeof data['min_balance'] !== 'undefined')
            xData['minBalance'] = TypeTransformer.to('number')(data['min_balance']);
        if (typeof data['card_overrun_value'] !== 'undefined')
            xData['cardOverrunValue'] = TypeTransformer.to('string')(data['card_overrun_value']);
        if (typeof data['receipt_email'] !== 'undefined')
            xData['receiptEmail'] = TypeTransformer.to('string')(data['receipt_email']);
        return xData;
    },
    'GetSQQueuesResult': function (data) {
        ...
        if (typeof data['im_max_queue_size'] !== 'undefined')
            xData['imMaxQueueSize'] = TypeTransformer.to('number')(data['im_max_queue_size']);
        if (typeof data['agentcount'] !== 'undefined')
            xData['agentcount'] = TypeTransformer.to('number')(data['agentcount']);
        return xData;
    },
    ...
    'GetSQAgentsResult': function (data) {
        ...
        if (typeof data['user_display_name'] !== 'undefined')
            xData['userDisplayName'] = TypeTransformer.to('string')(data['user_display_name']);
        if (typeof data['max_simultaneous_conversations'] !== 'undefined')
            xData['maxSimultaneousConversations'] = TypeTransformer.to('number')(data['max_simultaneous_conversations']);
        if (typeof data['sq_statuses'] !== 'undefined')
            xData['sqStatuses'] = TypeTransformer.to('SmartQueueStateAgentStatus[]')(data['sq_statuses']);
    ...
    'SQTaskSelectionStrategies': function (data) {
        ...
        if (typeof data['MAX_WAITING_TIME'] !== 'undefined')
            xData['MAXWAITINGTIME'] = TypeTransformer.to('string')(data['MAX_WAITING_TIME']);
        return xData;
    },
    'SQSkillBindingModes': function (data) {
        ...
        if (typeof data['replace_skills'] !== 'undefined')
            xData['replaceSkills'] = TypeTransformer.to('string')(data['replace_skills']);
        if (typeof data['replace_agents'] !== 'undefined')
            xData['replaceAgents'] = TypeTransformer.to('string')(data['replace_agents']);
        return xData;
    },
    'SQAgentBindingModes': function (data) {
        ...
        if (typeof data['replace'] !== 'undefined')
            xData['replace'] = TypeTransformer.to('string')(data['replace']);
        return xData;
    },
    ...
    'SmartQueueAgent_Skill': function (data) {
        ...
        if (typeof data['sq_skill_name'] !== 'undefined')
            xData['sqSkillName'] = TypeTransformer.to('string')(data['sq_skill_name']);
        if (typeof data['sq_skill_level'] !== 'undefined')
            xData['sqSkillLevel'] = TypeTransformer.to('number')(data['sq_skill_level']);
        return xData;
    },
    ...
    'KeyValueItems': function (data) {
        ...
        if (typeof data['value'] !== 'undefined')
            xData['value'] = TypeTransformer.to('string')(data['value']);
        if (typeof data['expires_at'] !== 'undefined')
            xData['expiresAt'] = TypeTransformer.to('number')(data['expires_at']);
        return xData;
    },
    ...
    'InvoicePeriod': function (data) {
        ...
        if (typeof data['to'] !== 'undefined')
            xData['to'] = TypeTransformer.to('Date')(data['to']);
        return xData;
    },
    'InvoiceTotalDetails': function (data) {
        ...
        if (typeof data['total_amount'] !== 'undefined')
            xData['totalAmount'] = TypeTransformer.to('number')(data['total_amount']);
        if (typeof data['amount_to_pay'] !== 'undefined')
            xData['amountToPay'] = TypeTransformer.to('number')(data['amount_to_pay']);
        if (typeof data['discount_amount'] !== 'undefined')
            xData['discountAmount'] = TypeTransformer.to('number')(data['discount_amount']);
        if (typeof data['currency'] !== 'undefined')
            xData['currency'] = TypeTransformer.to('string')(data['currency']);
        return xData;
    },
    ...
    'InvoiceTaxesDetails': function (data) {
        ...
        if (typeof data['level'] !== 'undefined')
            xData['level'] = TypeTransformer.to('string')(data['level']);
        if (typeof data['rate'] !== 'undefined')
            xData['rate'] = TypeTransformer.to('number')(data['rate']);
        if (typeof data['name'] !== 'undefined')
            xData['name'] = TypeTransformer.to('string')(data['name']);
        if (typeof data['currency'] !== 'undefined')
            xData['currency'] = TypeTransformer.to('string')(data['currency']);
...
TypeTransformer.toActors = {
    'APIError': function (data) {
        const xData = {};
        if (typeof data['code'] !== 'undefined')
            xData['code'] = TypeTransformer.from('number')(data['code']);
        if (typeof data['msg'] !== 'undefined')
            xData['msg'] = TypeTransformer.from('string')(data['msg']);
        return xData;
    },
    'AccountInfo': function (data) {
        ...
        if (typeof data['accountName'] !== 'undefined')
            xData['account_name'] = TypeTransformer.from('string')(data['accountName']);
        ...
        if (typeof data['accountFirstName'] !== 'undefined')
            xData['account_first_name'] = TypeTransformer.from('string')(data['accountFirstName']);
        if (typeof data['accountLastName'] !== 'undefined')
            xData['account_last_name'] = TypeTransformer.from('string')(data['accountLastName']);
        if (typeof data['created'] !== 'undefined')
            xData['created'] = TypeTransformer.from('Date')(data['created']);
        if (typeof data['languageCode'] !== 'undefined')
            xData['language_code'] = TypeTransformer.from('string')(data['languageCode']);
        if (typeof data['location'] !== 'undefined')
            xData['location'] = TypeTransformer.from('string')(data['location']);
        if (typeof data['minBalanceToNotify'] !== 'undefined')
            xData['min_balance_to_notify'] = TypeTransformer.from('number')(data['minBalanceToNotify']);
        if (typeof data['accountNotifications'] !== 'undefined')
            xData['account_notifications'] = TypeTransformer.from('boolean')(data['accountNotifications']);
        if (typeof data['tariffChangingNotifications'] !== 'undefined')
            xData['tariff_changing_notifications'] = TypeTransformer.from('boolean')(data['tariffChangingNotifications']);
        if (typeof data['newsNotifications'] !== 'undefined')
            xData['news_notifications'] = TypeTransformer.from('boolean')(data['newsNotifications']);
        if (typeof data['billingAddressName'] !== 'undefined')
            xData['billing_address_name'] = TypeTransformer.from('string')(data['billingAddressName']);
        if (typeof data['billingAddressCountryCode'] !== 'undefined')
            xData['billing_address_country_code'] = TypeTransformer.from('string')(data['billingAddressCountryCode']);
        if (typeof data['billingAddressAddress'] !== 'undefined')
            xData['billing_address_address'] = TypeTransformer.from('string')(data['billingAddressAddress']);
        if (typeof data['billingAddressZip'] !== 'undefined')
            xData['billing_address_zip'] = TypeTransformer.from('string')(data['billingAddressZip']);
        if (typeof data['billingAddressPhone'] !== 'undefined')
            xData['billing_address_phone'] = TypeTransformer.from('string')(data['billingAddressPhone']);
        if (typeof data['billingAddressState'] !== 'undefined')
            xData['billing_address_state'] = TypeTransformer.from('string')(data['billingAddressState']);
        if (typeof data['active'] !== 'undefined')
            xData['active'] = TypeTransformer.from('boolean')(data['active']);
        if (typeof data['frozen'] !== 'undefined')
            xData['frozen'] = TypeTransformer.from('boolean')(data['frozen']);
        if (typeof data['balance'] !== 'undefined')
            xData['balance'] = TypeTransformer.from('number')(data['balance']);
        if (typeof data['creditLimit'] !== 'undefined')
            xData['credit_limit'] = TypeTransformer.from('number')(data['creditLimit']);
        if (typeof data['currency'] !== 'undefined')
            xData['currency'] = TypeTransformer.from('string')(data['currency']);
        if (typeof data['supportRobokassa'] !== 'undefined')
            xData['support_robokassa'] = TypeTransformer.from('boolean')(data['supportRobokassa']);
        if (typeof data['supportBankCard'] !== 'undefined')
            xData['support_bank_card'] = TypeTransformer.from('boolean')(data['supportBankCard']);
        if (typeof data['supportInvoice'] !== 'undefined')
            xData['support_invoice'] = TypeTransformer.from('boolean')(data['supportInvoice']);
        if (typeof data['accountCustomData'] !== 'undefined')
            xData['account_custom_data'] = TypeTransformer.from('string')(data['accountCustomData']);
        if (typeof data['accessEntries'] !== 'undefined')
            xData['access_entries'] = TypeTransformer.from('string[]')(data['accessEntries']);
        if (typeof data['withAccessEntries'] !== 'undefined')
            xData['with_access_entries'] = TypeTransformer.from('boolean')(data['withAccessEntries']);
        if (typeof data['callbackUrl'] !== 'undefined')
            xData['callback_url'] = TypeTransformer.from('string')(data['callbackUrl']);
        if (typeof data['callbackSalt'] !== 'undefined')
            xData['callback_salt'] = TypeTransformer.from('string')(data['callbackSalt']);
    ...
    'AccountPlan': function (data) {
        ...
        if (typeof data['planSubscriptionTemplateId'] !== 'undefined')
            xData['plan_subscription_template_id'] = TypeTransformer.from('number')(data['planSubscriptionTemplateId']);
        if (typeof data['nextCharge'] !== 'undefined')
            xData['next_charge'] = TypeTransformer.from('Date')(data['nextCharge']);
        if (typeof data['planType'] !== 'undefined')
            xData['plan_type'] = TypeTransformer.from('string')(data['planType']);
        if (typeof data['planName'] !== 'undefined')
            xData['plan_name'] = TypeTransformer.from('string')(data['planName']);
    ...
    'AccountPlanPackage': function (data) {
        ...
        if (typeof data['packageName'] !== 'undefined')
            xData['package_name'] = TypeTransformer.from('string')(data['packageName']);
        if (typeof data['mayOverrun'] !== 'undefined')
            xData['may_overrun'] = TypeTransformer.from('boolean')(data['mayOverrun']);
        if (typeof data['overrunPrice'] !== 'undefined')
            xData['overrun_price'] = TypeTransformer.from('number')(data['overrunPrice']);
        if (typeof data['overrunResources'] !== 'undefined')
            xData['overrun_resources'] = TypeTransformer.from('number')(data['overrunResources']);
        if (typeof data['resourceLeft'] !== 'undefined')
            xData['resource_left'] = TypeTransformer.from('number')(data['resourceLeft']);
        if (typeof data['packageSize'] !== 'undefined')
            xData['package_size'] = TypeTransformer.from('number')(data['packageSize']);
        if (typeof data['origPackageSize'] !== 'undefined')
            xData['orig_package_size'] = TypeTransformer.from('number')(data['origPackageSize']);
        return xData;
    },
    'Plan': function (data) {
        const xData = {};
    ...
    'ApplicationInfo': function (data) {
        ...
        if (typeof data['secureRecordStorage'] !== 'undefined')
            xData['secure_record_storage'] = TypeTransformer.from('boolean')(data['secureRecordStorage']);
        return xData;
    },
    ...
    'UserInfo': function (data) {
        ...
        if (typeof data['userName'] !== 'undefined')
            xData['user_name'] = TypeTransformer.from('string')(data['userName']);
        if (typeof data['userDisplayName'] !== 'undefined')
            xData['user_display_name'] = TypeTransformer.from('string')(data['userDisplayName']);
        if (typeof data['userActive'] !== 'undefined')
            xData['user_active'] = TypeTransformer.from('boolean')(data['userActive']);
        if (typeof data['parentAccounting'] !== 'undefined')
            xData['parent_accounting'] = TypeTransformer.from('boolean')(data['parentAccounting']);
        if (typeof data['liveBalance'] !== 'undefined')
            xData['live_balance'] = TypeTransformer.from('number')(data['liveBalance']);
        if (typeof data['balance'] !== 'undefined')
            xData['balance'] = TypeTransformer.from('number')(data['balance']);
        if (typeof data['fixedBalance'] !== 'undefined')
            xData['fixed_balance'] = TypeTransformer.from('number')(data['fixedBalance']);
        ...
        if (typeof data['acdStatusChangeTime'] !== 'undefined')
            xData['acd_status_change_time'] = TypeTransformer.from('Date')(data['acdStatusChangeTime']);
        if (typeof data['created'] !== 'undefined')
            xData['created'] = TypeTransformer.from('Date')(data['created']);
        if (typeof data['modified'] !== 'undefined')
            xData['modified'] = TypeTransformer.from('Date')(data['modified']);
    ...
    'ScenarioInfo': function (data) {
        ...
        if (typeof data['scenarioName'] !== 'undefined')
            xData['scenario_name'] = TypeTransformer.from('string')(data['scenarioName']);
        if (typeof data['scenarioScript'] !== 'undefined')
            xData['scenario_script'] = TypeTransformer.from('string')(data['scenarioScript']);
        if (typeof data['modified'] !== 'undefined')
            xData['modified'] = TypeTransformer.from('Date')(data['modified']);
        if (typeof data['parent'] !== 'undefined')
            xData['parent'] = TypeTransformer.from('boolean')(data['parent']);
        return xData;
    },
    ...
    'RuleInfo': function (data) {
        ...
        if (typeof data['rulePattern'] !== 'undefined')
            xData['rule_pattern'] = TypeTransformer.from('string')(data['rulePattern']);
        if (typeof data['rulePatternExclude'] !== 'undefined')
            xData['rule_pattern_exclude'] = TypeTransformer.from('string')(data['rulePatternExclude']);
    ...
    'SipWhiteListInfo': function (data) {
        ...
        if (typeof data['sipWhitelistNetwork'] !== 'undefined')
            xData['sip_whitelist_network'] = TypeTransformer.from('string')(data['sipWhitelistNetwork']);
        if (typeof data['description'] !== 'undefined')
    ...
    'CallSessionInfo': function (data) {
        ...
        if (typeof data['applicationName'] !== 'undefined')
            xData['application_name'] = TypeTransformer.from('string')(data['applicationName']);
        if (typeof data['callSessionHistoryId'] !== 'undefined')
            xData['call_session_history_id'] = TypeTransformer.from('number')(data['callSessionHistoryId']);
        if (typeof data['accountId'] !== 'undefined')
            xData['account_id'] = TypeTransformer.from('number')(data['accountId']);
        if (typeof data['applicationId'] !== 'undefined')
            xData['application_id'] = TypeTransformer.from('number')(data['applicationId']);
        ...
        if (typeof data['startDate'] !== 'undefined')
            xData['start_date'] = TypeTransformer.from('Date')(data['startDate']);
        if (typeof data['duration'] !== 'undefined')
            xData['duration'] = TypeTransformer.from('number')(data['duration']);
        if (typeof data['initiatorAddress'] !== 'undefined')
            xData['initiator_address'] = TypeTransformer.from('string')(data['initiatorAddress']);
        if (typeof data['mediaServerAddress'] !== 'undefined')
            xData['media_server_address'] = TypeTransformer.from('string')(data['mediaServerAddress']);
        if (typeof data['logFileUrl'] !== 'undefined')
            xData['log_file_url'] = TypeTransformer.from('string')(data['logFileUrl']);
        ...
        if (typeof data['otherResourceUsage'] !== 'undefined')
            xData['other_resource_usage'] = TypeTransformer.from('ResourceUsage[]')(data['otherResourceUsage']);
        if (typeof data['records'] !== 'undefined')
    ...
    'CallInfo': function (data) {
        ...
        if (typeof data['localNumber'] !== 'undefined')
            xData['local_number'] = TypeTransformer.from('string')(data['localNumber']);
        if (typeof data['remoteNumber'] !== 'undefined')
            xData['remote_number'] = TypeTransformer.from('string')(data['remoteNumber']);
        if (typeof data['remoteNumberType'] !== 'undefined')
            xData['remote_number_type'] = TypeTransformer.from('string')(data['remoteNumberType']);
        if (typeof data['incoming'] !== 'undefined')
            xData['incoming'] = TypeTransformer.from('boolean')(data['incoming']);
        if (typeof data['successful'] !== 'undefined')
            xData['successful'] = TypeTransformer.from('boolean')(data['successful']);
    ...
    'TransactionInfo': function (data) {
        ...
        if (typeof data['transactionId'] !== 'undefined')
            xData['transaction_id'] = TypeTransformer.from('number')(data['transactionId']);
        if (typeof data['accountId'] !== 'undefined')
            xData['account_id'] = TypeTransformer.from('string')(data['accountId']);
        if (typeof data['performedAt'] !== 'undefined')
            xData['performed_at'] = TypeTransformer.from('Date')(data['performedAt']);
        if (typeof data['amount'] !== 'undefined')
            xData['amount'] = TypeTransformer.from('number')(data['amount']);
        if (typeof data['currency'] !== 'undefined')
            xData['currency'] = TypeTransformer.from('string')(data['currency']);
        if (typeof data['transactionType'] !== 'undefined')
            xData['transaction_type'] = TypeTransformer.from('string')(data['transactionType']);
        if (typeof data['transactionDescription'] !== 'undefined')
            xData['transaction_description'] = TypeTransformer.from('string')(data['transactionDescription']);
        return xData;
    },
    'ResourceUsage': function (data) {
        ...
        if (typeof data['description'] !== 'undefined')
            xData['description'] = TypeTransformer.from('string')(data['description']);
        if (typeof data['usedAt'] !== 'undefined')
            xData['used_at'] = TypeTransformer.from('Date')(data['usedAt']);
        if (typeof data['transactionId'] !== 'undefined')
            xData['transaction_id'] = TypeTransformer.from('number')(data['transactionId']);
        if (typeof data['resourceQuantity'] !== 'undefined')
            xData['resource_quantity'] = TypeTransformer.from('number')(data['resourceQuantity']);
        if (typeof data['unit'] !== 'undefined')
            xData['unit'] = TypeTransformer.from('string')(data['unit']);
        if (typeof data['refCallId'] !== 'undefined')
            xData['ref_call_id'] = TypeTransformer.from('number')(data['refCallId']);
        return xData;
    },
    'Record': function (data) {
        ...
        if (typeof data['recordName'] !== 'undefined')
            xData['record_name'] = TypeTransformer.from('string')(data['recordName']);
        if (typeof data['cost'] !== 'undefined')
            xData['cost'] = TypeTransformer.from('number')(data['cost']);
        if (typeof data['startTime'] !== 'undefined')
            xData['start_time'] = TypeTransformer.from('Date')(data['startTime']);
        ...
        if (typeof data['transcriptionUrl'] !== 'undefined')
            xData['transcription_url'] = TypeTransformer.from('string')(data['transcriptionUrl']);
        if (typeof data['transcriptionStatus'] !== 'undefined')
            xData['transcription_status'] = TypeTransformer.from('string')(data['transcriptionStatus']);
        return xData;
    },
    'AuditLogInfo': function (data) {
        ...
        if (typeof data['accountId'] !== 'undefined')
            xData['account_id'] = TypeTransformer.from('number')(data['accountId']);
        if (typeof data['requested'] !== 'undefined')
            xData['requested'] = TypeTransformer.from('Date')(data['requested']);
        if (typeof data['ip'] !== 'undefined')
            xData['ip'] = TypeTransformer.from('string')(data['ip']);
    ...
    'CalculatedCallHistoryData': function (data) {
        ...
        if (typeof data['totalSessionCount'] !== 'undefined')
            xData['total_session_count'] = TypeTransformer.from('number')(data['totalSessionCount']);
        if (typeof data['timezone'] !== 'undefined')
            xData['timezone'] = TypeTransformer.from('string')(data['timezone']);
        return xData;
    },
    'CalculatedTransactionHistoryData': function (data) {
        ...
        if (typeof data['totalTransactionCount'] !== 'undefined')
            xData['total_transaction_count'] = TypeTransformer.from('number')(data['totalTransactionCount']);
        if (typeof data['startBalance'] !== 'undefined')
            xData['start_balance'] = TypeTransformer.from('string')(data['startBalance']);
        if (typeof data['endBalance'] !== 'undefined')
            xData['end_balance'] = TypeTransformer.from('string')(data['endBalance']);
        if (typeof data['accountId'] !== 'undefined')
            xData['account_id'] = TypeTransformer.from('number')(data['accountId']);
        if (typeof data['userId'] !== 'undefined')
            xData['user_id'] = TypeTransformer.from('number')(data['userId']);
        if (typeof data['userName'] !== 'undefined')
            xData['user_name'] = TypeTransformer.from('number')(data['userName']);
        if (typeof data['timezone'] !== 'undefined')
            xData['timezone'] = TypeTransformer.from('string')(data['timezone']);
        return xData;
    },
    'ACDSessionInfo': function (data) {
        ...
        if (typeof data['acdSessionHistoryId'] !== 'undefined')
            xData['acd_session_history_id'] = TypeTransformer.from('number')(data['acdSessionHistoryId']);
        if (typeof data['acdRequestId'] !== 'undefined')
            xData['acd_request_id'] = TypeTransformer.from('string')(data['acdRequestId']);
        if (typeof data['accountId'] !== 'undefined')
            xData['account_id'] = TypeTransformer.from('number')(data['accountId']);
        if (typeof data['beginTime'] !== 'undefined')
            xData['begin_time'] = TypeTransformer.from('Date')(data['beginTime']);
        if (typeof data['priority'] !== 'undefined')
            xData['priority'] = TypeTransformer.from('number')(data['priority']);
        if (typeof data['acdQueueId'] !== 'undefined')
            xData['acd_queue_id'] = TypeTransformer.from('number')(data['acdQueueId']);
        if (typeof data['userId'] !== 'undefined')
            xData['user_id'] = TypeTransformer.from('number')(data['userId']);
        if (typeof data['waitingDuration'] !== 'undefined')
            xData['waiting_duration'] = TypeTransformer.from('number')(data['waitingDuration']);
        if (typeof data['inServiceDuration'] !== 'undefined')
            xData['in_service_duration'] = TypeTransformer.from('number')(data['inServiceDuration']);
        if (typeof data['afterServiceDuration'] !== 'undefined')
            xData['after_service_duration'] = TypeTransformer.from('number')(data['afterServiceDuration']);
        if (typeof data['events'] !== 'undefined')
    ...
    'ACDSessionEventInfo': function (data) {
        ...
        if (typeof data['time'] !== 'undefined')
            xData['time'] = TypeTransformer.from('Date')(data['time']);
        if (typeof data['type'] !== 'undefined')
    ...
    'QueueInfo': function (data) {
        ...
        if (typeof data['acdQueueId'] !== 'undefined')
            xData['acd_queue_id'] = TypeTransformer.from('number')(data['acdQueueId']);
        if (typeof data['acdQueueName'] !== 'undefined')
            xData['acd_queue_name'] = TypeTransformer.from('string')(data['acdQueueName']);
        if (typeof data['applicationId'] !== 'undefined')
            xData['application_id'] = TypeTransformer.from('number')(data['applicationId']);
        if (typeof data['acdQueuePriority'] !== 'undefined')
            xData['acd_queue_priority'] = TypeTransformer.from('number')(data['acdQueuePriority']);
        if (typeof data['serviceProbability'] !== 'undefined')
            xData['service_probability'] = TypeTransformer.from('number')(data['serviceProbability']);
        if (typeof data['autoBinding'] !== 'undefined')
            xData['auto_binding'] = TypeTransformer.from('boolean')(data['autoBinding']);
        if (typeof data['maxWaitingTime'] !== 'undefined')
            xData['max_waiting_time'] = TypeTransformer.from('number')(data['maxWaitingTime']);
        if (typeof data['maxQueueSize'] !== 'undefined')
            xData['max_queue_size'] = TypeTransformer.from('number')(data['maxQueueSize']);
        if (typeof data['averageServiceTime'] !== 'undefined')
            xData['average_service_time'] = TypeTransformer.from('number')(data['averageServiceTime']);
        if (typeof data['created'] !== 'undefined')
            xData['created'] = TypeTransformer.from('Date')(data['created']);
        if (typeof data['modified'] !== 'undefined')
            xData['modified'] = TypeTransformer.from('Date')(data['modified']);
        ...
        if (typeof data['operatorcount'] !== 'undefined')
            xData['operatorcount'] = TypeTransformer.from('number')(data['operatorcount']);
        return xData;
    },
    'QueueSkills': function (data) {
        const xData = {};
        ...
        if (typeof data['skillName'] !== 'undefined')
            xData['skill_name'] = TypeTransformer.from('string')(data['skillName']);
        return xData;
    },
    'QueueUsers': function (data) {
        const xData = {};
    ...
    'ACDOperatorStatusAggregationGroup': function (data) {
        ...
        if (typeof data['hour'] !== 'undefined')
            xData['hour'] = TypeTransformer.from('number')(data['hour']);
        if (typeof data['statistics'] !== 'undefined')
            xData['statistics'] = TypeTransformer.from('ACDOperatorStatusStatistics[]')(data['statistics']);
        return xData;
    },
    'ACDOperatorStatistics': function (data) {
        ...
        if (typeof data['UAC'] !== 'undefined')
            xData['UAC'] = TypeTransformer.from('number')(data['UAC']);
        if (typeof data['TDT'] !== 'undefined')
            xData['TDT'] = TypeTransformer.from('number')(data['TDT']);
        if (typeof data['THT'] !== 'undefined')
            xData['THT'] = TypeTransformer.from('number')(data['THT']);
        if (typeof data['TTT'] !== 'undefined')
            xData['TTT'] = TypeTransformer.from('number')(data['TTT']);
        if (typeof data['TACW'] !== 'undefined')
            xData['TACW'] = TypeTransformer.from('number')(data['TACW']);
        return xData;
    },
    'ACDOperatorStatusStatistics': function (data) {
        ...
        if (typeof data['hour'] !== 'undefined')
            xData['hour'] = TypeTransformer.from('number')(data['hour']);
        if (typeof data['acdStatus'] !== 'undefined')
            xData['acd_status'] = TypeTransformer.from('ACDOperatorStatusStatisticsDetail[]')(data['acdStatus']);
        return xData;
    },
    'ACDOperatorStatusStatisticsDetail': function (data) {
        const xData = {};
    ...
    'ACDQueueStatistics': function (data) {
        ...
        if (typeof data['TST'] !== 'undefined')
            xData['TST'] = TypeTransformer.from('number')(data['TST']);
        if (typeof data['TAT'] !== 'undefined')
            xData['TAT'] = TypeTransformer.from('number')(data['TAT']);
        if (typeof data['THT'] !== 'undefined')
            xData['THT'] = TypeTransformer.from('number')(data['THT']);
        if (typeof data['TTT'] !== 'undefined')
            xData['TTT'] = TypeTransformer.from('number')(data['TTT']);
    ...
    'ACDQueueStatisticsServiceLevel': function (data) {
        ...
        if (typeof data['acceptableWaitingTime'] !== 'undefined')
            xData['acceptable_waiting_time'] = TypeTransformer.from('number')(data['acceptableWaitingTime']);
        if (typeof data['callCount'] !== 'undefined')
            xData['call_count'] = TypeTransformer.from('number')(data['callCount']);
        if (typeof data['serviceLevel'] !== 'undefined')
            xData['service_level'] = TypeTransformer.from('number')(data['serviceLevel']);
        return xData;
    },
    'ACDStatisticsItem': function (data) {
        ...
        if (typeof data['avg'] !== 'undefined')
            xData['avg'] = TypeTransformer.from('number')(data['avg']);
        if (typeof data['max'] !== 'undefined')
            xData['max'] = TypeTransformer.from('number')(data['max']);
        if (typeof data['count'] !== 'undefined')
            xData['count'] = TypeTransformer.from('number')(data['count']);
        if (typeof data['sum'] !== 'undefined')
            xData['sum'] = TypeTransformer.from('number')(data['sum']);
        return xData;
    },
    'ACDStatisticsCalls': function (data) {
        const xData = {};
        if (typeof data['count'] !== 'undefined')
            xData['count'] = TypeTransformer.from('number')(data['count']);
        if (typeof data['percent'] !== 'undefined')
            xData['percent'] = TypeTransformer.from('number')(data['percent']);
        return xData;
    },
    'ACDQueueState': function (data) {
        ...
        if (typeof data['readyOperators'] !== 'undefined')
            xData['ready_operators'] = TypeTransformer.from('ACDReadyOperatorState[]')(data['readyOperators']);
        if (typeof data['readyOperatorsCount'] !== 'undefined')
            xData['ready_operators_count'] = TypeTransformer.from('number')(data['readyOperatorsCount']);
        if (typeof data['lockedOperators'] !== 'undefined')
            xData['locked_operators'] = TypeTransformer.from('ACDLockedOperatorState[]')(data['lockedOperators']);
        if (typeof data['lockedOperatorsCount'] !== 'undefined')
            xData['locked_operators_count'] = TypeTransformer.from('number')(data['lockedOperatorsCount']);
        if (typeof data['afterServiceOperators'] !== 'undefined')
            xData['after_service_operators'] = TypeTransformer.from('ACDAfterServiceOperatorState[]')(data['afterServiceOperators']);
        if (typeof data['afterServiceOperatorCount'] !== 'undefined')
            xData['after_service_operator_count'] = TypeTransformer.from('number')(data['afterServiceOperatorCount']);
        if (typeof data['servicingCalls'] !== 'undefined')
            xData['servicing_calls'] = TypeTransformer.from('ACDServicingCallState[]')(data['servicingCalls']);
        if (typeof data['waitingCalls'] !== 'undefined')
            xData['waiting_calls'] = TypeTransformer.from('ACDWaitingCallState[]')(data['waitingCalls']);
        return xData;
    },
    'ACDReadyOperatorState': function (data) {
        ...
        if (typeof data['userDisplayName'] !== 'undefined')
            xData['user_display_name'] = TypeTransformer.from('string')(data['userDisplayName']);
        if (typeof data['idleDuration'] !== 'undefined')
            xData['idle_duration'] = TypeTransformer.from('number')(data['idleDuration']);
        return xData;
    },
    ...
    'ACDOperatorCall': function (data) {
        ...
        if (typeof data['acdQueueName'] !== 'undefined')
            xData['acd_queue_name'] = TypeTransformer.from('string')(data['acdQueueName']);
        if (typeof data['callerid'] !== 'undefined')
            xData['callerid'] = TypeTransformer.from('string')(data['callerid']);
        if (typeof data['beginTime'] !== 'undefined')
            xData['begin_time'] = TypeTransformer.from('Date')(data['beginTime']);
        if (typeof data['submitted'] !== 'undefined')
            xData['submitted'] = TypeTransformer.from('Date')(data['submitted']);
        return xData;
    },
    ...
    'ACDWaitingCallState': function (data) {
        ...
        if (typeof data['waitingTime'] !== 'undefined')
            xData['waiting_time'] = TypeTransformer.from('number')(data['waitingTime']);
        if (typeof data['minutesToSubmit'] !== 'undefined')
            xData['minutes_to_submit'] = TypeTransformer.from('number')(data['minutesToSubmit']);
        if (typeof data['acdSessionHistoryId'] !== 'undefined')
            xData['acd_session_history_id'] = TypeTransformer.from('number')(data['acdSessionHistoryId']);
        return xData;
    },
    'NewPhoneInfo': function (data) {
        ...
        if (typeof data['phonePrice'] !== 'undefined')
            xData['phone_price'] = TypeTransformer.from('number')(data['phonePrice']);
        if (typeof data['phoneInstallationPrice'] !== 'undefined')
            xData['phone_installation_price'] = TypeTransformer.from('number')(data['phoneInstallationPrice']);
        ...
        if (typeof data['phonePeriod'] !== 'undefined')
            xData['phone_period'] = TypeTransformer.from('string')(data['phonePeriod']);
        if (typeof data['phoneCategoryName'] !== 'undefined')
            xData['phone_category_name'] = TypeTransformer.from('string')(data['phoneCategoryName']);
        if (typeof data['phoneRegionName'] !== 'undefined')
            xData['phone_region_name'] = TypeTransformer.from('string')(data['phoneRegionName']);
        if (typeof data['phoneInstallationTaxReserve'] !== 'undefined')
            xData['phone_installation_tax_reserve'] = TypeTransformer.from('number')(data['phoneInstallationTaxReserve']);
        if (typeof data['phoneTaxReserve'] !== 'undefined')
    ...
    'AttachedPhoneInfo': function (data) {
        ...
        if (typeof data['phonePurchaseDate'] !== 'undefined')
            xData['phone_purchase_date'] = TypeTransformer.from('Date')(data['phonePurchaseDate']);
        if (typeof data['deactivated'] !== 'undefined')
            xData['deactivated'] = TypeTransformer.from('boolean')(data['deactivated']);
        if (typeof data['canceled'] !== 'undefined')
            xData['canceled'] = TypeTransformer.from('boolean')(data['canceled']);
        ...
        if (typeof data['requiredVerification'] !== 'undefined')
            xData['required_verification'] = TypeTransformer.from('boolean')(data['requiredVerification']);
        ...
        if (typeof data['canBeUsed'] !== 'undefined')
            xData['can_be_used'] = TypeTransformer.from('boolean')(data['canBeUsed']);
        if (typeof data['isSmsSupported'] !== 'undefined')
            xData['is_sms_supported'] = TypeTransformer.from('boolean')(data['isSmsSupported']);
        if (typeof data['isSmsEnabled'] !== 'undefined')
            xData['is_sms_enabled'] = TypeTransformer.from('boolean')(data['isSmsEnabled']);
        if (typeof data['incomingSmsCallbackUrl'] !== 'undefined')
            xData['incoming_sms_callback_url'] = TypeTransformer.from('string')(data['incomingSmsCallbackUrl']);
        if (typeof data['emergencyCallsToBeEnabled'] !== 'undefined')
            xData['emergency_calls_to_be_enabled'] = TypeTransformer.from('boolean')(data['emergencyCallsToBeEnabled']);
        if (typeof data['emergencyCallsEnabled'] !== 'undefined')
            xData['emergency_calls_enabled'] = TypeTransformer.from('boolean')(data['emergencyCallsEnabled']);
        if (typeof data['subscriptionId'] !== 'undefined')
            xData['subscription_id'] = TypeTransformer.from('number')(data['subscriptionId']);
        if (typeof data['extendedApplicationName'] !== 'undefined')
            xData['extended_application_name'] = TypeTransformer.from('string')(data['extendedApplicationName']);
        if (typeof data['phoneRegionName'] !== 'undefined')
            xData['phone_region_name'] = TypeTransformer.from('string')(data['phoneRegionName']);
        if (typeof data['modified'] !== 'undefined')
            xData['modified'] = TypeTransformer.from('Date')(data['modified']);
    ...
    'PhoneNumberCountryInfo': function (data) {
        ...
        if (typeof data['canListPhoneNumbers'] !== 'undefined')
            xData['can_list_phone_numbers'] = TypeTransformer.from('boolean')(data['canListPhoneNumbers']);
        if (typeof data['phoneCategories'] !== 'undefined')
            xData['phone_categories'] = TypeTransformer.from('PhoneNumberCountryCategoryInfo[]')(data['phoneCategories']);
        if (typeof data['emergencyCallsToBeEnabled'] !== 'undefined')
            xData['emergency_calls_to_be_enabled'] = TypeTransformer.from('boolean')(data['emergencyCallsToBeEnabled']);
        return xData;
    },
    'PhoneNumberCountryCategoryInfo': function (data) {
        ...
        if (typeof data['phoneCategoryName'] !== 'undefined')
            xData['phone_category_name'] = TypeTransformer.from('string')(data['phoneCategoryName']);
        if (typeof data['countryHasStates'] !== 'undefined')
            xData['country_has_states'] = TypeTransformer.from('boolean')(data['countryHasStates']);
        if (typeof data['localizedCountryName'] !== 'undefined')
            xData['localized_country_name'] = TypeTransformer.from('string')(data['localizedCountryName']);
        if (typeof data['localizedPhoneCategoryName'] !== 'undefined')
            xData['localized_phone_category_name'] = TypeTransformer.from('string')(data['localizedPhoneCategoryName']);
        if (typeof data['localizedPhoneRegionName'] !== 'undefined')
            xData['localized_phone_region_name'] = TypeTransformer.from('string')(data['localizedPhoneRegionName']);
        return xData;
    },
    'PhoneNumberCountryStateInfo': function (data) {
        ...
        if (typeof data['countryStateName'] !== 'undefined')
            xData['country_state_name'] = TypeTransformer.from('string')(data['countryStateName']);
        return xData;
    },
    'PhoneNumberCountryRegionInfo': function (data) {
        ...
        if (typeof data['phoneRegionName'] !== 'undefined')
            xData['phone_region_name'] = TypeTransformer.from('string')(data['phoneRegionName']);
        if (typeof data['phoneRegionCode'] !== 'undefined')
            xData['phone_region_code'] = TypeTransformer.from('string')(data['phoneRegionCode']);
        if (typeof data['phoneCount'] !== 'undefined')
            xData['phone_count'] = TypeTransformer.from('number')(data['phoneCount']);
        if (typeof data['verificationStatus'] !== 'undefined')
            xData['verification_status'] = TypeTransformer.from('string')(data['verificationStatus']);
        if (typeof data['requiredVerification'] !== 'undefined')
            xData['required_verification'] = TypeTransformer.from('boolean')(data['requiredVerification']);
        ...
        if (typeof data['phonePeriod'] !== 'undefined')
            xData['phone_period'] = TypeTransformer.from('string')(data['phonePeriod']);
        if (typeof data['isNeedRegulationAddress'] !== 'undefined')
            xData['is_need_regulation_address'] = TypeTransformer.from('boolean')(data['isNeedRegulationAddress']);
        if (typeof data['regulationAddressType'] !== 'undefined')
            xData['regulation_address_type'] = TypeTransformer.from('string')(data['regulationAddressType']);
        if (typeof data['isSmsSupported'] !== 'undefined')
            xData['is_sms_supported'] = TypeTransformer.from('boolean')(data['isSmsSupported']);
        if (typeof data['multipleNumbersPrice'] !== 'undefined')
            xData['multiple_numbers_price'] = TypeTransformer.from('MultipleNumbersPrice[]')(data['multipleNumbersPrice']);
        if (typeof data['localizedCountryName'] !== 'undefined')
            xData['localized_country_name'] = TypeTransformer.from('string')(data['localizedCountryName']);
        if (typeof data['localizedPhoneCategoryName'] !== 'undefined')
            xData['localized_phone_category_name'] = TypeTransformer.from('string')(data['localizedPhoneCategoryName']);
    ...
    'MultipleNumbersPrice': function (data) {
        ...
        if (typeof data['count'] !== 'undefined')
            xData['count'] = TypeTransformer.from('number')(data['count']);
        if (typeof data['price'] !== 'undefined')
            xData['price'] = TypeTransformer.from('number')(data['price']);
        if (typeof data['installationPrice'] !== 'undefined')
            xData['installation_price'] = TypeTransformer.from('number')(data['installationPrice']);
        if (typeof data['installationTaxReserve'] !== 'undefined')
            xData['installation_tax_reserve'] = TypeTransformer.from('number')(data['installationTaxReserve']);
        if (typeof data['taxReserve'] !== 'undefined')
            xData['tax_reserve'] = TypeTransformer.from('number')(data['taxReserve']);
        return xData;
    },
    'CallerIDInfo': function (data) {
        ...
        if (typeof data['calleridNumber'] !== 'undefined')
            xData['callerid_number'] = TypeTransformer.from('string')(data['calleridNumber']);
        if (typeof data['active'] !== 'undefined')
            xData['active'] = TypeTransformer.from('boolean')(data['active']);
        if (typeof data['codeEnteringAttemptsLeft'] !== 'undefined')
            xData['code_entering_attempts_left'] = TypeTransformer.from('number')(data['codeEnteringAttemptsLeft']);
        if (typeof data['verificationCallAttemptsLeft'] !== 'undefined')
            xData['verification_call_attempts_left'] = TypeTransformer.from('number')(data['verificationCallAttemptsLeft']);
        if (typeof data['verifiedUntil'] !== 'undefined')
            xData['verified_until'] = TypeTransformer.from('Date')(data['verifiedUntil']);
        return xData;
    },
    'OutboundTestPhonenumberInfo': function (data) {
        ...
        if (typeof data['isVerified'] !== 'undefined')
            xData['is_verified'] = TypeTransformer.from('boolean')(data['isVerified']);
        if (typeof data['countryCode'] !== 'undefined')
            xData['country_code'] = TypeTransformer.from('string')(data['countryCode']);
        return xData;
    },
    'ContactInfo': function (data) {
        ...
        if (typeof data['contactType'] !== 'undefined')
            xData['contact_type'] = TypeTransformer.from('string')(data['contactType']);
        if (typeof data['contactData'] !== 'undefined')
            xData['contact_data'] = TypeTransformer.from('string')(data['contactData']);
        if (typeof data['isPersistent'] !== 'undefined')
            xData['is_persistent'] = TypeTransformer.from('boolean')(data['isPersistent']);
        if (typeof data['description'] !== 'undefined')
            xData['description'] = TypeTransformer.from('string')(data['description']);
        if (typeof data['nextVerificationAfterSec'] !== 'undefined')
            xData['next_verification_after_sec'] = TypeTransformer.from('number')(data['nextVerificationAfterSec']);
        if (typeof data['verified'] !== 'undefined')
            xData['verified'] = TypeTransformer.from('Date')(data['verified']);
        if (typeof data['notificationGroup'] !== 'undefined')
            xData['notification_group'] = TypeTransformer.from('string[]')(data['notificationGroup']);
        if (typeof data['created'] !== 'undefined')
            xData['created'] = TypeTransformer.from('Date')(data['created']);
        if (typeof data['modified'] !== 'undefined')
            xData['modified'] = TypeTransformer.from('Date')(data['modified']);
    ...
    'ACDQueueOperatorInfo': function (data) {
        ...
        if (typeof data['acdQueueName'] !== 'undefined')
            xData['acd_queue_name'] = TypeTransformer.from('string')(data['acdQueueName']);
        if (typeof data['autoLink'] !== 'undefined')
            xData['auto_link'] = TypeTransformer.from('boolean')(data['autoLink']);
        return xData;
    },
    ...
    'ExchangeRates': function (data) {
        ...
        if (typeof data['EUR'] !== 'undefined')
            xData['EUR'] = TypeTransformer.from('number')(data['EUR']);
        if (typeof data['USD'] !== 'undefined')
            xData['USD'] = TypeTransformer.from('number')(data['USD']);
        return xData;
    },
    'ResourcePrice': function (data) {
        const xData = {};
    ...
    'PriceGroup': function (data) {
        ...
        if (typeof data['price'] !== 'undefined')
            xData['price'] = TypeTransformer.from('number')(data['price']);
        if (typeof data['numResourcesPerPrice'] !== 'undefined')
            xData['num_resources_per_price'] = TypeTransformer.from('number')(data['numResourcesPerPrice']);
        if (typeof data['quantum'] !== 'undefined')
    ...
    'ResourceParams': function (data) {
        ...
        if (typeof data['forbidden'] !== 'undefined')
            xData['forbidden'] = TypeTransformer.from('string[]')(data['forbidden']);
        if (typeof data['requested'] !== 'undefined')
            xData['requested'] = TypeTransformer.from('string[]')(data['requested']);
        return xData;
    },
    'CallList': function (data) {
        ...
        if (typeof data['listName'] !== 'undefined')
            xData['list_name'] = TypeTransformer.from('string')(data['listName']);
        if (typeof data['priority'] !== 'undefined')
            xData['priority'] = TypeTransformer.from('number')(data['priority']);
        if (typeof data['ruleId'] !== 'undefined')
            xData['rule_id'] = TypeTransformer.from('number')(data['ruleId']);
        if (typeof data['maxSimultaneous'] !== 'undefined')
            xData['max_simultaneous'] = TypeTransformer.from('number')(data['maxSimultaneous']);
        if (typeof data['numAttempts'] !== 'undefined')
            xData['num_attempts'] = TypeTransformer.from('number')(data['numAttempts']);
        if (typeof data['dtSubmit'] !== 'undefined')
            xData['dt_submit'] = TypeTransformer.from('Date')(data['dtSubmit']);
        if (typeof data['dtComplete'] !== 'undefined')
            xData['dt_complete'] = TypeTransformer.from('Date')(data['dtComplete']);
    ...
    'CallListDetail': function (data) {
        ...
        if (typeof data['resultData'] !== 'undefined')
            xData['result_data'] = TypeTransformer.from('string')(data['resultData']);
        if (typeof data['lastAttempt'] !== 'undefined')
            xData['last_attempt'] = TypeTransformer.from('string')(data['lastAttempt']);
        if (typeof data['attemptsLeft'] !== 'undefined')
            xData['attempts_left'] = TypeTransformer.from('number')(data['attemptsLeft']);
    ...
    'SIPRegistration': function (data) {
        ...
        if (typeof data['sipUsername'] !== 'undefined')
            xData['sip_username'] = TypeTransformer.from('string')(data['sipUsername']);
        if (typeof data['proxy'] !== 'undefined')
            xData['proxy'] = TypeTransformer.from('string')(data['proxy']);
        if (typeof data['lastUpdated'] !== 'undefined')
            xData['last_updated'] = TypeTransformer.from('number')(data['lastUpdated']);
        if (typeof data['authUser'] !== 'undefined')
            xData['auth_user'] = TypeTransformer.from('string')(data['authUser']);
        if (typeof data['outboundProxy'] !== 'undefined')
            xData['outbound_proxy'] = TypeTransformer.from('string')(data['outboundProxy']);
        if (typeof data['successful'] !== 'undefined')
            xData['successful'] = TypeTransformer.from('boolean')(data['successful']);
        if (typeof data['statusCode'] !== 'undefined')
            xData['status_code'] = TypeTransformer.from('number')(data['statusCode']);
        if (typeof data['errorMessage'] !== 'undefined')
            xData['error_message'] = TypeTransformer.from('string')(data['errorMessage']);
        if (typeof data['deactivated'] !== 'undefined')
            xData['deactivated'] = TypeTransformer.from('boolean')(data['deactivated']);
        if (typeof data['nextSubscriptionRenewal'] !== 'undefined')
            xData['next_subscription_renewal'] = TypeTransformer.from('Date')(data['nextSubscriptionRenewal']);
        if (typeof data['purchaseDate'] !== 'undefined')
            xData['purchase_date'] = TypeTransformer.from('Date')(data['purchaseDate']);
        if (typeof data['subscriptionPrice'] !== 'undefined')
            xData['subscription_price'] = TypeTransformer.from('string')(data['subscriptionPrice']);
        if (typeof data['isPersistent'] !== 'undefined')
            xData['is_persistent'] = TypeTransformer.from('boolean')(data['isPersistent']);
        if (typeof data['userId'] !== 'undefined')
            xData['user_id'] = TypeTransformer.from('number')(data['userId']);
    ...
    'AdminUser': function (data) {
        ...
        if (typeof data['adminUserDisplayName'] !== 'undefined')
            xData['admin_user_display_name'] = TypeTransformer.from('string')(data['adminUserDisplayName']);
    ...
    'ClonedAdminUser': function (data) {
        ...
        if (typeof data['adminUserName'] !== 'undefined')
            xData['admin_user_name'] = TypeTransformer.from('string')(data['adminUserName']);
        if (typeof data['adminUserApiKey'] !== 'undefined')
            xData['admin_user_api_key'] = TypeTransformer.from('string')(data['adminUserApiKey']);
        return xData;
    },
    'GetMoneyAmountToChargeResult': function (data) {
        const xData = {};
        ...
        if (typeof data['minAmount'] !== 'undefined')
            xData['min_amount'] = TypeTransformer.from('number')(data['minAmount']);
        if (typeof data['bankCardAmountUsd'] !== 'undefined')
            xData['bank_card_amount_usd'] = TypeTransformer.from('number')(data['bankCardAmountUsd']);
        if (typeof data['minBankCardAmountUsd'] !== 'undefined')
            xData['min_bank_card_amount_usd'] = TypeTransformer.from('number')(data['minBankCardAmountUsd']);
        if (typeof data['robokassaAmountRub'] !== 'undefined')
            xData['robokassa_amount_rub'] = TypeTransformer.from('number')(data['robokassaAmountRub']);
        if (typeof data['minRobokassaAmountRub'] !== 'undefined')
            xData['min_robokassa_amount_rub'] = TypeTransformer.from('number')(data['minRobokassaAmountRub']);
        if (typeof data['subscriptions'] !== 'undefined')
            xData['subscriptions'] = TypeTransformer.from('SubscriptionsToCharge[]')(data['subscriptions']);
        return xData;
    },
    'ChargeAccountResult': function (data) {
        const xData = {};
    ...
    'ChargedPhone': function (data) {
        ...
        if (typeof data['deactivated'] !== 'undefined')
            xData['deactivated'] = TypeTransformer.from('boolean')(data['deactivated']);
        if (typeof data['isCharged'] !== 'undefined')
            xData['is_charged'] = TypeTransformer.from('boolean')(data['isCharged']);
        return xData;
    },
    'SubscriptionsToCharge': function (data) {
        ...
        if (typeof data['subscriptionType'] !== 'undefined')
            xData['subscription_type'] = TypeTransformer.from('string')(data['subscriptionType']);
        if (typeof data['subscriptionDescription'] !== 'undefined')
            xData['subscription_description'] = TypeTransformer.from('string')(data['subscriptionDescription']);
        if (typeof data['subscriptionAutoCharge'] !== 'undefined')
            xData['subscription_auto_charge'] = TypeTransformer.from('boolean')(data['subscriptionAutoCharge']);
        if (typeof data['subscriptionNextRenewal'] !== 'undefined')
            xData['subscription_next_renewal'] = TypeTransformer.from('Date')(data['subscriptionNextRenewal']);
        return xData;
    },
    'AuthorizedAccountIP': function (data) {
        ...
        if (typeof data['allowed'] !== 'undefined')
            xData['allowed'] = TypeTransformer.from('boolean')(data['allowed']);
        if (typeof data['created'] !== 'undefined')
            xData['created'] = TypeTransformer.from('Date')(data['created']);
        return xData;
    },
    'AccountVerificationDocument': function (data) {
        ...
        if (typeof data['isIndividual'] !== 'undefined')
            xData['is_individual'] = TypeTransformer.from('boolean')(data['isIndividual']);
        if (typeof data['comment'] !== 'undefined')
            xData['comment'] = TypeTransformer.from('string')(data['comment']);
        if (typeof data['uploaded'] !== 'undefined')
            xData['uploaded'] = TypeTransformer.from('Date')(data['uploaded']);
        if (typeof data['accountDocumentStatus'] !== 'undefined')
            xData['account_document_status'] = TypeTransformer.from('string')(data['accountDocumentStatus']);
        return xData;
    },
    'AccountVerification': function (data) {
        ...
        if (typeof data['unverifiedHoldUntil'] !== 'undefined')
            xData['unverified_hold_until'] = TypeTransformer.from('Date')(data['unverifiedHoldUntil']);
        if (typeof data['documents'] !== 'undefined')
            xData['documents'] = TypeTransformer.from('AccountVerificationDocument[]')(data['documents']);
        return xData;
    },
    'AccountVerifications': function (data) {
        const xData = {};
        if (typeof data['accountId'] !== 'undefined')
            xData['account_id'] = TypeTransformer.from('number')(data['accountId']);
        if (typeof data['verifications'] !== 'undefined')
            xData['verifications'] = TypeTransformer.from('AccountVerification[]')(data['verifications']);
        return xData;
    },
    'SubscriptionTemplate': function (data) {
        const xData = {};
        if (typeof data['subscriptionTemplateId'] !== 'undefined')
            xData['subscription_template_id'] = TypeTransformer.from('number')(data['subscriptionTemplateId']);
        ...
        if (typeof data['installationPriceInCurrency'] !== 'undefined')
            xData['installation_price_in_currency'] = TypeTransformer.from('number')(data['installationPriceInCurrency']);
        if (typeof data['price'] !== 'undefined')
            xData['price'] = TypeTransformer.from('number')(data['price']);
        if (typeof data['priceInCurrency'] !== 'undefined')
            xData['price_in_currency'] = TypeTransformer.from('number')(data['priceInCurrency']);
        if (typeof data['period'] !== 'undefined')
            xData['period'] = TypeTransformer.from('string')(data['period']);
        if (typeof data['subscriptionTemplateType'] !== 'undefined')
            xData['subscription_template_type'] = TypeTransformer.from('string')(data['subscriptionTemplateType']);
        if (typeof data['subscriptionTemplateName'] !== 'undefined')
            xData['subscription_template_name'] = TypeTransformer.from('string')(data['subscriptionTemplateName']);
        if (typeof data['requiredVerification'] !== 'undefined')
            xData['required_verification'] = TypeTransformer.from('boolean')(data['requiredVerification']);
        if (typeof data['verificationStatus'] !== 'undefined')
            xData['verification_status'] = TypeTransformer.from('string')(data['verificationStatus']);
    ...
    'AccountCallback': function (data) {
        ...
        if (typeof data['accountId'] !== 'undefined')
            xData['account_id'] = TypeTransformer.from('number')(data['accountId']);
        if (typeof data['hash'] !== 'undefined')
            xData['hash'] = TypeTransformer.from('string')(data['hash']);
        if (typeof data['accountName'] !== 'undefined')
            xData['account_name'] = TypeTransformer.from('string')(data['accountName']);
        if (typeof data['accountEmail'] !== 'undefined')
            xData['account_email'] = TypeTransformer.from('string')(data['accountEmail']);
        ...
        if (typeof data['accountDocumentUploaded'] !== 'undefined')
            xData['account_document_uploaded'] = TypeTransformer.from('AccountDocumentUploadedCallback')(data['accountDocumentUploaded']);
        if (typeof data['regulationAddressUploaded'] !== 'undefined')
            xData['regulation_address_uploaded'] = TypeTransformer.from('RegulationAddressUploadedCallback')(data['regulationAddressUploaded']);
        if (typeof data['accountDocumentVerified'] !== 'undefined')
            xData['account_document_verified'] = TypeTransformer.from('AccountDocumentVerifiedCallback')(data['accountDocumentVerified']);
        if (typeof data['accountIsFrozen'] !== 'undefined')
            xData['account_is_frozen'] = TypeTransformer.from('AccountIsFrozenCallback')(data['accountIsFrozen']);
        if (typeof data['accountIsUnfrozen'] !== 'undefined')
            xData['account_is_unfrozen'] = TypeTransformer.from('AccountIsUnfrozenCallback')(data['accountIsUnfrozen']);
        if (typeof data['activateSuccessful'] !== 'undefined')
            xData['activate_successful'] = TypeTransformer.from('ActivateSuccessfulCallback')(data['activateSuccessful']);
        if (typeof data['callHistoryReport'] !== 'undefined')
            xData['call_history_report'] = TypeTransformer.from('CallHistoryReportCallback')(data['callHistoryReport']);
        ...
        if (typeof data['cardExpiresInMonth'] !== 'undefined')
            xData['card_expires_in_month'] = TypeTransformer.from('CardExpiresInMonthCallback')(data['cardExpiresInMonth']);
        ...
        if (typeof data['cardPaymentFailed'] !== 'undefined')
            xData['card_payment_failed'] = TypeTransformer.from('CardPaymentFailedCallback')(data['cardPaymentFailed']);
        if (typeof data['robokassaPayment'] !== 'undefined')
            xData['robokassa_payment'] = TypeTransformer.from('RobokassaPaymentCallback')(data['robokassaPayment']);
        ...
        if (typeof data['regulationAddressVerified'] !== 'undefined')
            xData['regulation_address_verified'] = TypeTransformer.from('RegulationAddressVerifiedCallback')(data['regulationAddressVerified']);
        if (typeof data['renewedSubscriptions'] !== 'undefined')
            xData['renewed_subscriptions'] = TypeTransformer.from('RenewedSubscriptionsCallback')(data['renewedSubscriptions']);
        if (typeof data['resetAccountPasswordRequest'] !== 'undefined')
            xData['reset_account_password_request'] = TypeTransformer.from('ResetAccountPasswordRequestCallback')(data['resetAccountPasswordRequest']);
        if (typeof data['sipRegistrationFail'] !== 'undefined')
            xData['sip_registration_fail'] = TypeTransformer.from('SIPRegistrationFailCallback')(data['sipRegistrationFail']);
        if (typeof data['sipRegistrationRecovered'] !== 'undefined')
            xData['sip_registration_recovered'] = TypeTransformer.from('SIPRegistrationRecoveredCallback')(data['sipRegistrationRecovered']);
        if (typeof data['subscriptionIsFrozen'] !== 'undefined')
            xData['subscription_is_frozen'] = TypeTransformer.from('SubscriptionIsFrozenCallback')(data['subscriptionIsFrozen']);
        if (typeof data['subscriptionIsDetached'] !== 'undefined')
            xData['subscription_is_detached'] = TypeTransformer.from('SubscriptionIsDetachedCallback')(data['subscriptionIsDetached']);
        if (typeof data['transactionHistoryReport'] !== 'undefined')
            xData['transaction_history_report'] = TypeTransformer.from('TransactionHistoryReportCallback')(data['transactionHistoryReport']);
        if (typeof data['unverifiedSubscriptionDetached'] !== 'undefined')
            xData['unverified_subscription_detached'] = TypeTransformer.from('UnverifiedSubscriptionDetachedCallback')(data['unverifiedSubscriptionDetached']);
        if (typeof data['expiringCallerid'] !== 'undefined')
            xData['expiring_callerid'] = TypeTransformer.from('ExpiringCallerIDCallback')(data['expiringCallerid']);
        if (typeof data['transcriptionComplete'] !== 'undefined')
            xData['transcription_complete'] = TypeTransformer.from('TranscriptionCompleteCallback')(data['transcriptionComplete']);
        ...
        if (typeof data['expiringAgreement'] !== 'undefined')
            xData['expiring_agreement'] = TypeTransformer.from('ExpiringAgreementCallback')(data['expiringAgreement']);
        if (typeof data['expiredAgreement'] !== 'undefined')
            xData['expired_agreement'] = TypeTransformer.from('ExpiredAgreementCallback')(data['expiredAgreement']);
        if (typeof data['restoredAgreementStatus'] !== 'undefined')
            xData['restored_agreement_status'] = TypeTransformer.from('RestoredAgreementStatusCallback')(data['restoredAgreementStatus']);
        if (typeof data['nextChargeAlert'] !== 'undefined')
            xData['next_charge_alert'] = TypeTransformer.from('NextChargeAlertCallback')(data['nextChargeAlert']);
        if (typeof data['certificateExpired'] !== 'undefined')
            xData['certificate_expired'] = TypeTransformer.from('CertificateExpiredCallback')(data['certificateExpired']);
        if (typeof data['expiredCertificates'] !== 'undefined')
            xData['expired_certificates'] = TypeTransformer.from('ExpiredCertificateCallback')(data['expiredCertificates']);
        if (typeof data['expiringCertificates'] !== 'undefined')
            xData['expiring_certificates'] = TypeTransformer.from('ExpiringCertificateCallback')(data['expiringCertificates']);
        if (typeof data['accountDocumentStatusUpdated'] !== 'undefined')
            xData['account_document_status_updated'] = TypeTransformer.from('AccountDocumentStatusUpdatedCallback')(data['accountDocumentStatusUpdated']);
        if (typeof data['a2pSmsActivated'] !== 'undefined')
            xData['a2p_sms_activated'] = TypeTransformer.from('A2PActivatedCallback')(data['a2pSmsActivated']);
        if (typeof data['regulationAddressDocumentsRequested'] !== 'undefined')
            xData['regulation_address_documents_requested'] = TypeTransformer.from('RegulationAddressDocumentsRequestedCallback')(data['regulationAddressDocumentsRequested']);
        if (typeof data['invoiceReceived'] !== 'undefined')
            xData['invoice_received'] = TypeTransformer.from('InvoiceReceivedCallback')(data['invoiceReceived']);
        return xData;
    },
    'A2PSmsDeliveryCallback': function (data) {
        const xData = {};
        ...
        if (typeof data['status'] !== 'undefined')
            xData['status'] = TypeTransformer.from('string')(data['status']);
        if (typeof data['destinationNumbers'] !== 'undefined')
            xData['destination_numbers'] = TypeTransformer.from('string')(data['destinationNumbers']);
        return xData;
    },
    'AccountDocumentUploadedCallback': function (data) {
        const xData = {};
    ...
    'RegulationAddressUploadedCallback': function (data) {
        ...
        if (typeof data['regulationAddressId'] !== 'undefined')
            xData['regulation_address_id'] = TypeTransformer.from('number')(data['regulationAddressId']);
        if (typeof data['uploaded'] !== 'undefined')
            xData['uploaded'] = TypeTransformer.from('Date')(data['uploaded']);
        if (typeof data['isIndividual'] !== 'undefined')
            xData['is_individual'] = TypeTransformer.from('boolean')(data['isIndividual']);
        if (typeof data['regulationAddressName'] !== 'undefined')
            xData['regulation_address_name'] = TypeTransformer.from('string')(data['regulationAddressName']);
        return xData;
    },
    'AccountDocumentVerifiedCallback': function (data) {
        const xData = {};
    ...
    'CallHistoryReportCallback': function (data) {
        ...
        if (typeof data['historyReportId'] !== 'undefined')
            xData['history_report_id'] = TypeTransformer.from('number')(data['historyReportId']);
        if (typeof data['success'] !== 'undefined')
            xData['success'] = TypeTransformer.from('boolean')(data['success']);
        if (typeof data['orderDate'] !== 'undefined')
            xData['order_date'] = TypeTransformer.from('Date')(data['orderDate']);
        return xData;
    },
    'CardExpiredCallback': function (data) {
        const xData = {};
    ...
    'MinBalanceCallback': function (data) {
        ...
        if (typeof data['isRepeated'] !== 'undefined')
            xData['is_repeated'] = TypeTransformer.from('boolean')(data['isRepeated']);
        return xData;
    },
    'RegulationAddressVerifiedCallback': function (data) {
        const xData = {};
        if (typeof data['regulationAddressId'] !== 'undefined')
            xData['regulation_address_id'] = TypeTransformer.from('number')(data['regulationAddressId']);
        if (typeof data['regulationAddressStatus'] !== 'undefined')
            xData['regulation_address_status'] = TypeTransformer.from('string')(data['regulationAddressStatus']);
        if (typeof data['uploaded'] !== 'undefined')
            xData['uploaded'] = TypeTransformer.from('Date')(data['uploaded']);
        if (typeof data['isIndividual'] !== 'undefined')
            xData['is_individual'] = TypeTransformer.from('boolean')(data['isIndividual']);
    ...
    'RenewedSubscriptionsCallback': function (data) {
        const xData = {};
        if (typeof data['subscriptions'] !== 'undefined')
            xData['subscriptions'] = TypeTransformer.from('RenewedSubscriptionsCallbackItem[]')(data['subscriptions']);
        return xData;
    },
    'RenewedSubscriptionsCallbackItem': function (data) {
        const xData = {};
    ...
    'SIPRegistrationFailCallback': function (data) {
        ...
        if (typeof data['sipRegistrations'] !== 'undefined')
            xData['sip_registrations'] = TypeTransformer.from('SIPRegistrationIsFailedCallbackItem[]')(data['sipRegistrations']);
        return xData;
    },
    'SIPRegistrationIsFailedCallbackItem': function (data) {
        const xData = {};
        if (typeof data['sipRegistrationId'] !== 'undefined')
            xData['sip_registration_id'] = TypeTransformer.from('number')(data['sipRegistrationId']);
        if (typeof data['statusCode'] !== 'undefined')
            xData['status_code'] = TypeTransformer.from('string')(data['statusCode']);
        if (typeof data['errorMessage'] !== 'undefined')
            xData['error_message'] = TypeTransformer.from('string')(data['errorMessage']);
        return xData;
    },
    'SIPRegistrationRecoveredCallback': function (data) {
        const xData = {};
        if (typeof data['sipRegistrations'] !== 'undefined')
            xData['sip_registrations'] = TypeTransformer.from('SIPRegistrationIsRecoveredCallbackItem[]')(data['sipRegistrations']);
        return xData;
    },
    'SIPRegistrationIsRecoveredCallbackItem': function (data) {
        const xData = {};
    ...
    'SubscriptionIsDetachedCallback': function (data) {
        const xData = {};
        if (typeof data['subscriptions'] !== 'undefined')
            xData['subscriptions'] = TypeTransformer.from('SubscriptionIsDetachedCallbackItem[]')(data['subscriptions']);
        return xData;
    },
    'SubscriptionIsDetachedCallbackItem': function (data) {
        const xData = {};
    ...
    'SubscriptionIsFrozenCallback': function (data) {
        const xData = {};
        if (typeof data['subscriptions'] !== 'undefined')
            xData['subscriptions'] = TypeTransformer.from('SubscriptionIsFrozenCallbackItem[]')(data['subscriptions']);
        return xData;
    },
    'SubscriptionIsFrozenCallbackItem': function (data) {
        const xData = {};
    ...
    'UnverifiedSubscriptionDetachedCallback': function (data) {
        const xData = {};
        if (typeof data['subscriptions'] !== 'undefined')
            xData['subscriptions'] = TypeTransformer.from('UnverifiedSubscriptionDetachedCallbackItem[]')(data['subscriptions']);
        return xData;
    },
    'UnverifiedSubscriptionDetachedCallbackItem': function (data) {
        const xData = {};
    ...
    'TranscriptionCompleteCallback': function (data) {
        const xData = {};
        if (typeof data['transcriptionComplete'] !== 'undefined')
            xData['transcription_complete'] = TypeTransformer.from('TranscriptionCompleteCallbackItem')(data['transcriptionComplete']);
        return xData;
    },
    'TranscriptionCompleteCallbackItem': function (data) {
        const xData = {};
        ...
        if (typeof data['callSessionHistoryId'] !== 'undefined')
            xData['call_session_history_id'] = TypeTransformer.from('number')(data['callSessionHistoryId']);
        if (typeof data['transcriptionCost'] !== 'undefined')
            xData['transcription_cost'] = TypeTransformer.from('number')(data['transcriptionCost']);
        return xData;
    },
    'ExpiringAgreementCallback': function (data) {
        const xData = {};
        if (typeof data['expirationDate'] !== 'undefined')
            xData['expiration_date'] = TypeTransformer.from('Date')(data['expirationDate']);
        if (typeof data['untilExpiration'] !== 'undefined')
            xData['until_expiration'] = TypeTransformer.from('number')(data['untilExpiration']);
        return xData;
    },
    'NextChargeAlertCallback': function (data) {
        const xData = {};
        ...
        if (typeof data['insufficientFundsAmount'] !== 'undefined')
            xData['insufficient_funds_amount'] = TypeTransformer.from('number')(data['insufficientFundsAmount']);
        return xData;
    },
    'CertificateExpiredCallback': function (data) {
        const xData = {};
    ...
    'CertificateInfo': function (data) {
        ...
        if (typeof data['expirationDate'] !== 'undefined')
            xData['expiration_date'] = TypeTransformer.from('Date')(data['expirationDate']);
        if (typeof data['applications'] !== 'undefined')
            xData['applications'] = TypeTransformer.from('string[]')(data['applications']);
        return xData;
    },
    'SubscriptionCallbackDetails': function (data) {
        const xData = {};
        ...
        if (typeof data['phoneNumbers'] !== 'undefined')
            xData['phone_numbers'] = TypeTransformer.from('SubscriptionCallbackDetailsPhoneNumbers[]')(data['phoneNumbers']);
        if (typeof data['sipRegistrations'] !== 'undefined')
            xData['sip_registrations'] = TypeTransformer.from('SubscriptionCallbackDetailsSipRegistrations[]')(data['sipRegistrations']);
        return xData;
    },
    'SubscriptionCallbackDetailsPhoneNumbers': function (data) {
        const xData = {};
    ...
    'AccountDocumentStatusUpdatedCallback': function (data) {
        ...
        if (typeof data['accountDocumentId'] !== 'undefined')
            xData['account_document_id'] = TypeTransformer.from('number')(data['accountDocumentId']);
        if (typeof data['previousAccountDocumentStatus'] !== 'undefined')
            xData['previous_account_document_status'] = TypeTransformer.from('string')(data['previousAccountDocumentStatus']);
        if (typeof data['accountDocumentStatus'] !== 'undefined')
            xData['account_document_status'] = TypeTransformer.from('string')(data['accountDocumentStatus']);
        if (typeof data['updateTime'] !== 'undefined')
            xData['update_time'] = TypeTransformer.from('Date')(data['updateTime']);
        if (typeof data['comment'] !== 'undefined')
            xData['comment'] = TypeTransformer.from('string')(data['comment']);
        if (typeof data['legalStatus'] !== 'undefined')
            xData['legal_status'] = TypeTransformer.from('string')(data['legalStatus']);
    ...
    'InvoiceReceivedCallback': function (data) {
        ...
        if (typeof data['invoiceDate'] !== 'undefined')
            xData['invoice_date'] = TypeTransformer.from('Date')(data['invoiceDate']);
        if (typeof data['receivalDate'] !== 'undefined')
            xData['receival_date'] = TypeTransformer.from('Date')(data['receivalDate']);
        if (typeof data['amount'] !== 'undefined')
            xData['amount'] = TypeTransformer.from('string')(data['amount']);
        if (typeof data['taxAmount'] !== 'undefined')
            xData['tax_amount'] = TypeTransformer.from('string')(data['taxAmount']);
        if (typeof data['currency'] !== 'undefined')
            xData['currency'] = TypeTransformer.from('string')(data['currency']);
        return xData;
    },
    'ZipCode': function (data) {
        ...
        if (typeof data['zipCode'] !== 'undefined')
            xData['zip_code'] = TypeTransformer.from('string')(data['zipCode']);
        return xData;
    },
    'RegulationCountry': function (data) {
        const xData = {};
        ...
        if (typeof data['countryName'] !== 'undefined')
            xData['country_name'] = TypeTransformer.from('string')(data['countryName']);
        return xData;
    },
    'RegulationAddress': function (data) {
        const xData = {};
        ...
        if (typeof data['externalId'] !== 'undefined')
            xData['external_id'] = TypeTransformer.from('string')(data['externalId']);
        if (typeof data['countryCode'] !== 'undefined')
            xData['country_code'] = TypeTransformer.from('string')(data['countryCode']);
        if (typeof data['phoneCategoryName'] !== 'undefined')
            xData['phone_category_name'] = TypeTransformer.from('string')(data['phoneCategoryName']);
        if (typeof data['salutation'] !== 'undefined')
            xData['salutation'] = TypeTransformer.from('string')(data['salutation']);
        if (typeof data['company'] !== 'undefined')
            xData['company'] = TypeTransformer.from('string')(data['company']);
        if (typeof data['firstName'] !== 'undefined')
            xData['first_name'] = TypeTransformer.from('string')(data['firstName']);
        if (typeof data['lastName'] !== 'undefined')
            xData['last_name'] = TypeTransformer.from('string')(data['lastName']);
        if (typeof data['ownerCountryCode'] !== 'undefined')
            xData['owner_country_code'] = TypeTransformer.from('string')(data['ownerCountryCode']);
        if (typeof data['city'] !== 'undefined')
            xData['city'] = TypeTransformer.from('string')(data['city']);
        if (typeof data['zipCode'] !== 'undefined')
            xData['zip_code'] = TypeTransformer.from('string')(data['zipCode']);
        if (typeof data['street'] !== 'undefined')
            xData['street'] = TypeTransformer.from('string')(data['street']);
        if (typeof data['builderNumber'] !== 'undefined')
            xData['builder_number'] = TypeTransformer.from('string')(data['builderNumber']);
        if (typeof data['builderLatter'] !== 'undefined')
            xData['builder_latter'] = TypeTransformer.from('string')(data['builderLatter']);
        if (typeof data['status'] !== 'undefined')
            xData['status'] = TypeTransformer.from('string')(data['status']);
        if (typeof data['rejectMessage'] !== 'undefined')
            xData['reject_message'] = TypeTransformer.from('string')(data['rejectMessage']);
        return xData;
    },
    'RegulationRegionRecord': function (data) {
        const xData = {};
    ...
    'BankCard': function (data) {
        ...
        if (typeof data['autoCharge'] !== 'undefined')
            xData['auto_charge'] = TypeTransformer.from('boolean')(data['autoCharge']);
        if (typeof data['minBalance '] !== 'undefined')
            xData['min_balance '] = TypeTransformer.from('number')(data['minBalance ']);
        if (typeof data['cardOverrunValue'] !== 'undefined')
            xData['card_overrun_value'] = TypeTransformer.from('number')(data['cardOverrunValue']);
        if (typeof data['expirationYear'] !== 'undefined')
            xData['expiration_year'] = TypeTransformer.from('number')(data['expirationYear']);
        if (typeof data['expirationMonth'] !== 'undefined')
            xData['expiration_month'] = TypeTransformer.from('number')(data['expirationMonth']);
        if (typeof data['acct'] !== 'undefined')
        ...
        if (typeof data['cardType'] !== 'undefined')
            xData['card_type'] = TypeTransformer.from('string')(data['cardType']);
        return xData;
    },
    ...
    'PstnBlackListInfo': function (data) {
        ...
        if (typeof data['pstnBlacklistPhone '] !== 'undefined')
            xData['pstn_blacklist_phone '] = TypeTransformer.from('string')(data['pstnBlacklistPhone ']);
        return xData;
    },
    'DialogflowKeyInfo': function (data) {
        const xData = {};
    ...
    'PushCredentialInfo': function (data) {
        ...
        if (typeof data['pushCredentialId'] !== 'undefined')
            xData['push_credential_id'] = TypeTransformer.from('number')(data['pushCredentialId']);
        if (typeof data['pushProviderId'] !== 'undefined')
    ...
    'PushCredentialContent': function (data) {
        ...
        if (typeof data['certFileName'] !== 'undefined')
            xData['cert_file_name'] = TypeTransformer.from('string')(data['certFileName']);
        if (typeof data['certContent'] !== 'undefined')
            xData['cert_content'] = TypeTransformer.from('string')(data['certContent']);
        if (typeof data['isDevMode'] !== 'undefined')
            xData['is_dev_mode'] = TypeTransformer.from('boolean')(data['isDevMode']);
        if (typeof data['senderId'] !== 'undefined')
            xData['sender_id'] = TypeTransformer.from('string')(data['senderId']);
        if (typeof data['huaweiClientId'] !== 'undefined')
            xData['huawei_client_id'] = TypeTransformer.from('string')(data['huaweiClientId']);
        if (typeof data['huaweiApplicationId'] !== 'undefined')
            xData['huawei_application_id'] = TypeTransformer.from('string')(data['huaweiApplicationId']);
        return xData;
    },
    'InboundSmsCallback': function (data) {
        const xData = {};
    ...
    'InboundSmsCallbackItem': function (data) {
        ...
        if (typeof data['smsBody'] !== 'undefined')
            xData['sms_body'] = TypeTransformer.from('string')(data['smsBody']);
        return xData;
    },
    'RecordStorageInfo': function (data) {
        ...
        if (typeof data['recordStorageName'] !== 'undefined')
            xData['record_storage_name'] = TypeTransformer.from('string')(data['recordStorageName']);
        return xData;
    },
    'SmsTransaction': function (data) {
        const xData = {};
    ...
    'FailedSms': function (data) {
        ...
        if (typeof data['errorDescription'] !== 'undefined')
            xData['error_description'] = TypeTransformer.from('string')(data['errorDescription']);
        if (typeof data['errorCode'] !== 'undefined')
            xData['error_code'] = TypeTransformer.from('number')(data['errorCode']);
        return xData;
    },
    'KeyInfo': function (data) {
        const xData = {};
        ...
        if (typeof data['privateKey'] !== 'undefined')
            xData['private_key'] = TypeTransformer.from('string')(data['privateKey']);
        return xData;
    },
    'KeyView': function (data) {
        const xData = {};
    ...
    'RoleView': function (data) {
        ...
        if (typeof data['roleId'] !== 'undefined')
            xData['role_id'] = TypeTransformer.from('number')(data['roleId']);
        if (typeof data['inherited'] !== 'undefined')
            xData['inherited'] = TypeTransformer.from('boolean')(data['inherited']);
        if (typeof data['childIds'] !== 'undefined')
            xData['child_ids'] = TypeTransformer.from('number[]')(data['childIds']);
        if (typeof data['parentRoleId'] !== 'undefined')
            xData['parent_role_id'] = TypeTransformer.from('number[]')(data['parentRoleId']);
        if (typeof data['guiOnly'] !== 'undefined')
            xData['gui_only'] = TypeTransformer.from('boolean')(data['guiOnly']);
        return xData;
    },
    'RoleGroupView': function (data) {
        const xData = {};
    ...
    'SmsHistory': function (data) {
        ...
        if (typeof data['messageId'] !== 'undefined')
            xData['message_id'] = TypeTransformer.from('number')(data['messageId']);
        if (typeof data['sourceNumber'] !== 'undefined')
            xData['source_number'] = TypeTransformer.from('number')(data['sourceNumber']);
        if (typeof data['destinationNumber'] !== 'undefined')
            xData['destination_number'] = TypeTransformer.from('number')(data['destinationNumber']);
        if (typeof data['direction'] !== 'undefined')
            xData['direction'] = TypeTransformer.from('string')(data['direction']);
        if (typeof data['fragments'] !== 'undefined')
            xData['fragments'] = TypeTransformer.from('number')(data['fragments']);
        if (typeof data['cost'] !== 'undefined')
            xData['cost'] = TypeTransformer.from('number')(data['cost']);
        if (typeof data['statusId'] !== 'undefined')
            xData['status_id'] = TypeTransformer.from('string')(data['statusId']);
        if (typeof data['errorMessage'] !== 'undefined')
            xData['error_message'] = TypeTransformer.from('string')(data['errorMessage']);
        if (typeof data['processedDate'] !== 'undefined')
            xData['processed_date'] = TypeTransformer.from('Date')(data['processedDate']);
        if (typeof data['transactionId'] !== 'undefined')
            xData['transaction_id'] = TypeTransformer.from('number')(data['transactionId']);
        if (typeof data['text'] !== 'undefined')
            xData['text'] = TypeTransformer.from('string')(data['text']);
        return xData;
    },
    'A2PSmsHistory': function (data) {
        ...
        if (typeof data['errorMessage'] !== 'undefined')
            xData['error_message'] = TypeTransformer.from('string')(data['errorMessage']);
        if (typeof data['processingDate'] !== 'undefined')
            xData['processing_date'] = TypeTransformer.from('Date')(data['processingDate']);
        if (typeof data['transactionId'] !== 'undefined')
            xData['transaction_id'] = TypeTransformer.from('number')(data['transactionId']);
        if (typeof data['deliveryStatus'] !== 'undefined')
            xData['delivery_status'] = TypeTransformer.from('string')(data['deliveryStatus']);
        if (typeof data['text'] !== 'undefined')
            xData['text'] = TypeTransformer.from('string')(data['text']);
        return xData;
    },
    ...
    'GetMaxBankCardPaymentResult': function (data) {
        ...
        if (typeof data['newMaxPayment'] !== 'undefined')
            xData['new_max_payment'] = TypeTransformer.from('number')(data['newMaxPayment']);
        if (typeof data['currency'] !== 'undefined')
            xData['currency'] = TypeTransformer.from('string')(data['currency']);
        return xData;
    },
    'GetAutochargeConfigResult': function (data) {
        ...
        if (typeof data['minBalance'] !== 'undefined')
            xData['min_balance'] = TypeTransformer.from('number')(data['minBalance']);
        if (typeof data['cardOverrunValue'] !== 'undefined')
            xData['card_overrun_value'] = TypeTransformer.from('string')(data['cardOverrunValue']);
        if (typeof data['receiptEmail'] !== 'undefined')
            xData['receipt_email'] = TypeTransformer.from('string')(data['receiptEmail']);
        return xData;
    },
    'GetSQQueuesResult': function (data) {
        const xData = {};
        ...
        if (typeof data['imMaxQueueSize'] !== 'undefined')
            xData['im_max_queue_size'] = TypeTransformer.from('number')(data['imMaxQueueSize']);
        if (typeof data['agentcount'] !== 'undefined')
            xData['agentcount'] = TypeTransformer.from('number')(data['agentcount']);
        return xData;
    },
    'GetSQSkillsResult': function (data) {
        const xData = {};
    ...
    'GetSQAgentsResult': function (data) {
        ...
        if (typeof data['userDisplayName'] !== 'undefined')
            xData['user_display_name'] = TypeTransformer.from('string')(data['userDisplayName']);
        if (typeof data['maxSimultaneousConversations'] !== 'undefined')
            xData['max_simultaneous_conversations'] = TypeTransformer.from('number')(data['maxSimultaneousConversations']);
        if (typeof data['sqStatuses'] !== 'undefined')
            xData['sq_statuses'] = TypeTransformer.from('SmartQueueStateAgentStatus[]')(data['sqStatuses']);
    ...
    'SQTaskSelectionStrategies': function (data) {
        ...
        if (typeof data['MAXWAITINGTIME'] !== 'undefined')
            xData['MAX_WAITING_TIME'] = TypeTransformer.from('string')(data['MAXWAITINGTIME']);
        return xData;
    },
    'SQSkillBindingModes': function (data) {
        const xData = {};
        ...
        if (typeof data['replaceSkills'] !== 'undefined')
            xData['replace_skills'] = TypeTransformer.from('string')(data['replaceSkills']);
        if (typeof data['replaceAgents'] !== 'undefined')
            xData['replace_agents'] = TypeTransformer.from('string')(data['replaceAgents']);
        return xData;
    },
    'SQAgentBindingModes': function (data) {
        const xData = {};
        ...
        if (typeof data['add'] !== 'undefined')
            xData['add'] = TypeTransformer.from('string')(data['add']);
        if (typeof data['replace'] !== 'undefined')
            xData['replace'] = TypeTransformer.from('string')(data['replace']);
        return xData;
    },
    'SmartQueueMetricsResult': function (data) {
        const xData = {};
    ...
    'SmartQueueMetricsGroupsValues': function (data) {
        ...
        if (typeof data['toDate'] !== 'undefined')
            xData['to_date'] = TypeTransformer.from('Date')(data['toDate']);
        if (typeof data['value'] !== 'undefined')
            xData['value'] = TypeTransformer.from('number')(data['value']);
        return xData;
    },
    'SmartQueueState': function (data) {
        const xData = {};
    ...
    'SmartQueueAgentSkill': function (data) {
        ...
        if (typeof data['sqSkillName'] !== 'undefined')
            xData['sq_skill_name'] = TypeTransformer.from('string')(data['sqSkillName']);
        if (typeof data['sqSkillLevel'] !== 'undefined')
            xData['sq_skill_level'] = TypeTransformer.from('number')(data['sqSkillLevel']);
        return xData;
    },
    ...
    'KeyValueItems': function (data) {
        ...
        if (typeof data['value'] !== 'undefined')
            xData['value'] = TypeTransformer.from('string')(data['value']);
        if (typeof data['expiresAt'] !== 'undefined')
            xData['expires_at'] = TypeTransformer.from('number')(data['expiresAt']);
        return xData;
    },
    'KeyValuePairs': function (data) {
        const xData = {};
    ...
    'InvoicePeriod': function (data) {
        ...
        if (typeof data['to'] !== 'undefined')
            xData['to'] = TypeTransformer.from('Date')(data['to']);
        return xData;
    },
    'InvoiceTotalDetails': function (data) {
        const xData = {};
        ...
        if (typeof data['totalAmount'] !== 'undefined')
            xData['total_amount'] = TypeTransformer.from('number')(data['totalAmount']);
        if (typeof data['amountToPay'] !== 'undefined')
            xData['amount_to_pay'] = TypeTransformer.from('number')(data['amountToPay']);
        if (typeof data['discountAmount'] !== 'undefined')
            xData['discount_amount'] = TypeTransformer.from('number')(data['discountAmount']);
        if (typeof data['currency'] !== 'undefined')
            xData['currency'] = TypeTransformer.from('string')(data['currency']);
        return xData;
    },
    ...
    'InvoiceTaxesDetails': function (data) {
        ...
        if (typeof data['amount'] !== 'undefined')
            xData['amount'] = TypeTransformer.from('number')(data['amount']);
        if (typeof data['level'] !== 'undefined')
            xData['level'] = TypeTransformer.from('string')(data['level']);
        if (typeof data['rate'] !== 'undefined')
            xData['rate'] = TypeTransformer.from('number')(data['rate']);
        if (typeof data['name'] !== 'undefined')
            xData['name'] = TypeTransformer.from('string')(data['name']);
        if (typeof data['currency'] !== 'undefined')
            xData['currency'] = TypeTransformer.from('string')(data['currency']);
